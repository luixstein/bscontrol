...
#Region "Procedimientos y funciones"
    ...
    Private Function BusquedaVisualDocumentosCXP() As String
        ...
        f.sQl = "SELECT CXP.FOLIO_CXP,CXP.ESTATUS_CXP,CXP.CODIGO_DOCUMENTO_CXP,T.NOMBRE_TIPO_DOCUMENTO,CXP.TOTAL,CXP.CODIGO_PROVEEDOR,CXP.NOMBRE_PROVEEDOR,DBO.FN_FECHA_SIN_HORA(CXP.FECHA) FECHA_CXP " & _
                "FROM VW_BANCOS_GLOBAL_CON_CXP_GLOBAL CXP INNER JOIN SIS_TIPOS_DOCUMENTOS T ON(CXP.CODIGO_TIPO_DOCUMENTO=T.CODIGO_TIPO_DOCUMENTO) WHERE T.CODIGO_MODULO='CXP' AND CXP.ESTATUS_CXP='G' AND CXP.CODIGO_PLAZA=" & Plaza.CODIGO_PLAZA & " AND "
