...
#Region "Eventos"
    ...
    Private Sub txtFolio_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFolio.KeyDown
        ...
        Select Case e.KeyCode
            Case Keys.F6
busca:
                sText = BusquedaVisualDocumentosCXC()
...
#Region "Procedimientos y funciones"
    ...
    Private Function BusquedaVisualDocumentosCXC() As String
        Dim f As New BusquedaVisual
        Dim Resultado As String = ""
        f.Text = "Búsqueda de documentos de CXC"
        f.sCampo = "CXC_FOLIO_CXC"
        f.sOrder = "FECHA_CXC DESC"
        f.sTable = "VW_BANCOS_GLOBAL_CON_CXC_GLOBAL"

        f.sQl = "SELECT CXC.CXC_FOLIO_CXC,CXC.CXC_ESTATUS_CXC,CXC.CXC_CODIGO_DOCUMENTO,T.NOMBRE_TIPO_DOCUMENTO,CXC.CXC_TOTAL,CXC.CXC_CODIGO_CLIENTE,CXC.CXC_NOMBRE_CLIENTE,DBO.FN_FECHA_SIN_HORA(CXC.BAN_FECHA) FECHA_CXC " & _
                "FROM VW_BANCOS_GLOBAL_CON_CXC_GLOBAL CXC INNER JOIN SIS_TIPOS_DOCUMENTOS T ON(CXC.CXC_CODIGO_TIPO_DOCUMENTO=T.CODIGO_TIPO_DOCUMENTO) WHERE T.CODIGO_MODULO='CXC' AND CXC.CXC_ESTATUS_CXC='G' AND"
        ...
        Try
            ...
            End If
        Catch ex As Exception
            HandleError(Me.Name, "BusquedaVisualDocumentosCXC", ex)
        End Try
        Return Resultado
    End Function
    ...
    Private Function BusquedaVisualDocumentosVentas() As String
        ...
        f.sQl = "SELECT V.FOLIO_VENTA,V.FECHA,V.TOTAL,V.SALDO,V.CODIGO_CLIENTE,C.NOMBRE_CLIENTE,V.ESTATUS_VENTA " & _
                "FROM VENTA_GLOBAL V INNER JOIN CAT_CLIENTES C ON(V.CODIGO_CLIENTE=C.CODIGO_CLIENTE)" & _
        ...
        End Try
        BusquedaVisualDocumentosVentas = Resultado
    End Function
    ...
    Private Function Validar() As Boolean
        ...
        If MsgBox("Desea aplicar el documento CXC : " & Me.txtFolio.Text & " en la referencia : " & _
