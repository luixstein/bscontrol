...
Public Class Frm_CXC_Pagos_OLD
        ...
        Try
            ...
            If e.Col = Me.iGySeleccion And e.Row > 0 Then
                If Me.Grid.Cell(Renglon, Me.iGySeleccion).Text = "1" And Me.ClickSinEjecutar = False Then
                    If Me.cboMoneda.SelectedIndex = 1 Then 'USD
                        If valorNumerico(Me.txtTipoCambio.Text) <= 0 Or valorNumerico(Me.txtTipoCambio.Text) > 20 Then
                    ...
                    Select Case Columna
                        ...
                        Case Me.iGyPago
                            ...
                            If dPago > 0 And txtLEN(Me.Grid.Cell(Renglon, Me.iGyFolio).Text) = True Then
                                If Me.cboMoneda.SelectedIndex = 0 Then 'MXN
...
#Region "Métodos y procedimientos"
    ...
    Private Sub CargaFacturas()
        ...
        End If
        Dim cmd As New SqlCommand("SELECT FECHA,FOLIO_VENTA,TOTAL,SALDO,TOTAL_DOLARES,SALDO_DOLARES, CASE WHEN TOTAL=SALDO THEN IMPUESTO ELSE 0 END IVA " &
    ...
    Private Function CargaVentasConSaldo() As Boolean
        ...
        Try
            ...
            For Each dRow As DataRow In dTabla.Rows
                Me.Grid.AddItem(dRow(0).ToString & Chr(9) & Format(CDate(dRow(1)), "dd-MMM-yyyy") & Chr(9) & dRow(2).ToString & Chr(9) & dRow(3).ToString & Chr(9) & dRow(4).ToString & Chr(9) &
