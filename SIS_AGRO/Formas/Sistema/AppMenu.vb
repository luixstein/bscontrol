...
#End Region
    ...
    Private Sub DepartamentosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DepartamentosToolStripMenuItem.Click
        Dim Child As New Catalogo_Departamentos
        Child.MdiParent = Me
        m_ChildFormNumber += 1
        Child.StartPosition = FormStartPosition.CenterScreen
        Child.Show()
    ...
    Private Sub RequisicionesGlobalToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RequisicionesGlobalToolStripMenuItem.Click
        Dim Child As New Rpt_Inventario_Requisiciones_Global
        Child.MdiParent = Me
        m_ChildFormNumber += 1
        Child.StartPosition = FormStartPosition.CenterScreen
        Child.Show()
    ...
    Private Sub EmbarquesPorSocioToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EmbarquesPorSocioToolStripMenuItem.Click
        Dim Child As New Rpt_Embarques_Socios_Estado_Resultados
        Child.MdiParent = Me
        m_ChildFormNumber += 1
        Child.StartPosition = FormStartPosition.CenterScreen
        Child.Show()
    ...
    Private Sub CalificasToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CalificasToolStripMenuItem.Click
        Dim Child As New Rpt_Ventas_Calificas
        Child.MdiParent = Me
        m_ChildFormNumber += 1
        Child.StartPosition = FormStartPosition.CenterScreen
        Child.Show()
