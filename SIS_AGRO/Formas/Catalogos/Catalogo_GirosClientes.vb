...
Public Class Catalogo_GirosClientes
    Private oGiroCliente As New Class_CatGirosClientes
...
#Region "Constructor y destructor"
    ...
    Sub New()
        ...
        Try
            Me.msgElemento = "Giro cliente"
            Me.msgElementos = "Giros de clientes"
            Me.Run = False
...
#Region "Opciones"
    Private Sub tsbNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNuevo.Click
        ...
        Me.Cambia_Estado()
        Me.TxtCodigo.Text = Me.oGiroCliente.CodigoSiguiente
    End Sub
    ...
    Private Sub tsbImprimirListado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbImprimirListado.Click
        Me.oGiroCliente.Imprimir_Listado()
    End Sub
#End Region
...
#Region "Métodos y procedimientos"
    ...
    Private Sub DesplegarElementos()
        Try
            With Me.Grid
                .DataSource = oGiroCliente.ObtenerElementos
                .Columns("CODIGO_GIRO").Width = 50
                .Columns("NOMBRE_GIRO").Width = 200
            End With
        Catch ex As Exception
    ...
    Private Sub LlenaElemento(ByVal sCodigo_Elemento As String)
        Try
            Me.oGiroCliente.CODIGO_GIRO = CInt(sCodigo_Elemento)
            If Me.oGiroCliente.Consultar Then
                With Me.oGiroCliente
                    Me.TxtCodigo.Text = .CODIGO_GIRO.ToString
                    Me.TxtNombre.Text = .NOMBRE_GIRO.ToString
    ...
    Private Sub Grabar()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO, enumEstados.EDICION
                Try
                    With Me.oGiroCliente
                        .CODIGO_GIRO = CInt(Me.TxtCodigo.Text)
                        .NOMBRE_GIRO = Me.TxtNombre.Text
    ...
    Private Function Validar() As Boolean
        ...
        Try
            If txtLEN(Me.TxtNombre.Text) = False Then
                MsgBox("Captúre el nombre del concepto.", MsgBoxStyle.Exclamation, Me.Text)
                Me.TxtNombre.Focus()
                Return False
            End If
...
#Region "Eventos de la lista de elementos"
    ...
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_GIRO").Value.ToString)
    End Sub
...
#Region " Eventos de TxtFiltro"
    ...
    Private Sub txtFiltro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFiltro.KeyDown
        Dim oElementosFiltro As New Class_CatGirosClientes
