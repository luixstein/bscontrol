...
Public Class Catalogo_Conceptos_GastosEmbarqueEmpaque
    Private oConcepto As New Class_CatConceptoGastoEmpaqueEmbarque
...
#Region "Métodos y procedimientos"
    ...
    Private Sub DesplegarElementos()
        With Me.Grid
            ...
            .Columns("CODIGO_CONCEPTO_GASTOS_EMBARQUE_EMPAQUE").Width = 150
            .Columns("NOMBRE_CONCEPTO_GASTOS_EMBARQUE_EMPAQUE").Width = 200
        End With

    End Sub

    Private Sub LlenaElemento(ByVal sCodigo_Elemento As String)
        Me.oConcepto.CODIGO_CONCEPTO_GASTOS_EMBARQUE_EMPAQUE = sCodigo_Elemento
...
#Region "Eventos de Grid"
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_CONCEPTO_GASTOS_EMBARQUE_EMPAQUE").Value.ToString)
    End Sub
...
#Region " Eventos de TxtFiltro"
    Private Sub txtFiltro_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtFiltro.TextChanged
        Dim oElementos As New Class_CatConceptoGastoEmpaqueEmbarque
    ...
    Private Sub txtFiltro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFiltro.KeyDown
        Dim oElementosFiltro As New Class_CatConceptoGastoEmpaqueEmbarque
