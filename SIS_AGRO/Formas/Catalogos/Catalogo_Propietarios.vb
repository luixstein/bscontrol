...
Public Class Catalogo_Propietarios
    Private oPropietario As New Class_CatPropietarios
...
#Region "Opciones"
    Private Sub tsbNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNuevo.Click
        ...
        Me.Cambia_Estado()
        Me.TxtCodigo.Text = Me.oPropietario.CodigoSiguiente.ToString
    End Sub
...
#Region "Métodos y procedimientos"
    ...
    Private Sub DesplegarElementos()
        With Me.Grid
            .DataSource = oPropietario.ObtenerElementosFiltro(Me.txtFiltro.Text)
    ...
    Private Sub DesplegarClientes()
        With Me.GridClientes
            .DataSource = oPropietario.ObtenerRelacionPropietariosClientes(Me.TxtCodigo.Text)
...
#Region "Eventos de la lista de elementos"
    ...
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(CInt(Me.Grid.CurrentRow.Cells("CODIGO_PROPIETARIO").Value))
    End Sub
