...
Public Class Cat_Nomina_Areas
    Private oArea As New Class_CatAreas
...
#Region "Opciones"
    Private Sub tsbNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNuevo.Click
        ...
        Me.Cambia_Estado()
        Me.TxtCodigoArea.Text = Me.oArea.CodigoSiguiente
    End Sub
    ...
    Private Sub tsbGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbGrabar.Click
        ...
        Select Case Me.Estado
            Case enumEstados.EDICION
                sMsg = " grabar las modificaciones del " & Me.msgElemento & " : " & Me.TxtCodigoArea.Text
            Case enumEstados.NUEVO
                sMsg = " agregar el " & Me.msgElemento & " : " & Me.TxtCodigoArea.Text
        End Select
        sMsg = "Deseas " & sMsg & " ?"
...
#Region "Métodos y procedimientos"
    ...
    Private Sub Cambia_Estado()
        Select Case Me.Estado
            Case enumEstados.NUEVO
                ...
                Me.TxtCodigoArea.Enabled = False
    ...
    Private Sub DesplegarElementos()
        With Me.Grid
            .DataSource = oArea.ObtenerElementos
            .Columns("CODIGO_AREA").Width = 50
            .Columns("NOMBRE_AREA").Width = 200
        End With
    End Sub

    Private Sub LlenaElemento(ByVal iCodigo_Elemento As String)
        Dim sCodigo As String
        Me.oArea.CODIGO_AREA = CInt(iCodigo_Elemento)
        If Me.oArea.Consultar Then
            With Me.oArea
                    ...
                    With Me.oArea
                        ...
                        If Grabado Then
                            ...
                            If Me.Estado = enumEstados.NUEVO Then
                                Me.TxtCodigoArea.Text = .CodigoSiguiente.ToString
                            End If
                        End If
                    End With
                Catch ex As Exception
    ...
    Private Function Validar() As Boolean
        ...
        If txtLEN(Me.TxtNombreArea.Text) = False Then
            MsgBox("Asígne un nombre al área.", MsgBoxStyle.Exclamation, Me.Text)
            Me.TxtNombreArea.Focus()
            Return bResultado
        End If
...
#Region "Eventos de la lista de elementos"
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_AREA").Value.ToString)
    End Sub
...
#Region " Eventos de TxtFiltro"
    Private Sub txtFiltro_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtFiltro.TextChanged
        ...
        With Me.Grid
            .DataSource = oArea.ObtenerElementosFiltro(Me.txtFiltro.Text)
            .Columns("CODIGO_AREA").Width = 50
            .Columns("NOMBRE_AREA").Width = 200
        End With
    End Sub
...
#Region "Eventos Genericos"
    ...
    Private Sub CboEstatus_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles CboEstatus.KeyDown
        ...
        End If
    End Sub
    Private Sub txt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CboEstatus.KeyPress, TxtNombreArea.KeyPress
        txtNoBeep(e)
    End Sub

    Private Sub txt_Keydown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtNombreArea.KeyDown
        If e.KeyCode = Keys.Return Then
            If txtLEN(Me.TxtNombreArea.Text) = False Then
                Exit Sub
            Else
    ...
    Private Sub ckbCalcularSindicato_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ckbCalcularSindicato.KeyDown
        If e.KeyCode = Keys.Return Then
            Select Case Me.Estado
                Case enumEstados.EDICION
                    SendKeys.Send("{TAB}")
    ...
    Private Sub txtNumericos_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtCodigoArea.KeyPress
