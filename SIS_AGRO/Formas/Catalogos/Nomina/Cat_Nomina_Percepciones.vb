...
Public Class Cat_Nomina_CatPercepciones
    Private oPercepcion As New Class_CatPercepcion
...
#Region "Opciones"
    Private Sub tsbNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNuevo.Click
        ...
        Me.Cambia_Estado()
        Me.TxtCodigoPercepcion.Text = Me.oPercepcion.CodigoSiguiente
    End Sub
    ...
    Private Sub tsbGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbGrabar.Click
        ...
        Select Case Me.Estado
            Case enumEstados.EDICION
                sMsg = " grabar las modificaciones del " & Me.msgElemento & " : " & Me.TxtCodigoPercepcion.Text
            Case enumEstados.NUEVO
                sMsg = " agregar el " & Me.msgElemento & " : " & Me.TxtCodigoPercepcion.Text
        End Select
        sMsg = "Deseas " & sMsg & " ?"
    ...
    Private Sub tsbImprimirListado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbImprimirListado.Click
        Me.oPercepcion.Imprimir_Listado()
    End Sub
#End Region
...
#Region "Métodos y procedimientos"
    ...
    Private Sub Cambia_Estado()
        Select Case Me.Estado
            Case enumEstados.NUEVO
                ...
                Me.TxtCodigoPercepcion.Enabled = False
                Me.TxtNombrePercepcion.Enabled = True
                Me.CboEstatus.Enabled = False
                Me.InicializaElemento()
                Me.TxtCodigoPercepcion.Focus()
    ...
    Private Sub DesplegarElementos()
        Dim oElementos As New Class_CatPercepcion
        With Me.Grid
            .DataSource = oElementos.ObtenerElementos
            .Columns("CODIGO_PERCEPCION").Width = 50
    ...
    Private Sub LlenaElemento(ByVal iCodigo_Elemento As String)
        ...
        Me.oPercepcion.CODIGO_PERCEPCION = CInt(iCodigo_Elemento)
        If Me.oPercepcion.Consultar Then
            With Me.oPercepcion
                sCodigo = "0000" + iCodigo_Elemento
                Me.TxtCodigoPercepcion.Text = sCodigo.Substring(Len(sCodigo) - 4)
                Me.TxtNombrePercepcion.Text = .NOMBRE.ToString
                If .REEMBOLSABLE = "1" Then
                    Me.cmbReembolsable.Text = "SI"
                Else
    ...
    Private Sub Grabar_Elemento()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO, enumEstados.EDICION
                Me.oPercepcion = New Class_CatPercepcion
                Try
                    With Me.oPercepcion
                        .CODIGO_PERCEPCION = CInt(Me.TxtCodigoPercepcion.Text)
                        .NOMBRE = Me.TxtNombrePercepcion.Text
                        If Me.cmbReembolsable.Text = "SI" Then
                            .REEMBOLSABLE = "1"
                        Else
                            .REEMBOLSABLE = "0"
                        End If
                        ...
                        If Grabado Then
                            ...
                            If Me.Estado = enumEstados.NUEVO Then
                                Me.TxtCodigoPercepcion.Text = .CodigoSiguiente.ToString
                            End If
                        End If
                    End With
                Catch ex As Exception
...
#Region "Eventos de la lista de elementos"
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_PERCEPCION").Value.ToString)
    End Sub
...
#Region " Eventos de TxtFiltro"
    ...
    Private Sub txtFiltro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFiltro.KeyDown
        Dim oElementosFiltro As New Class_CatPercepcion
...
#Region "Eventos Genericos"
    ...
    Private Sub txt_Keydown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtNombrePercepcion.KeyDown
        If e.KeyCode = Keys.Return Then
            Select Case Me.Estado
                Case enumEstados.EDICION
                    SendKeys.Send("{TAB}")
    ...
    Private Sub txtNumericos_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtCodigoPercepcion.KeyPress
