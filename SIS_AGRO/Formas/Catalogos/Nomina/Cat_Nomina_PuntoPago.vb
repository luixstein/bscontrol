...
Public Class Cat_Nomina_PuntoPago
    Private oPuntoPago As New Class_CatPuntoPago
...
#Region "Opciones"
    Private Sub tsbNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNuevo.Click
        ...
        Me.Cambia_Estado()
        Me.TxtCodigoPuntoPago.Text = Me.oPuntoPago.CodigoSiguiente
    End Sub
    ...
    Private Sub tsbGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbGrabar.Click
        ...
        Select Case Me.Estado
            Case enumEstados.EDICION
                sMsg = " grabar las modificaciones del " & Me.msgElemento & " : " & Me.TxtCodigoPuntoPago.Text
            Case enumEstados.NUEVO
                sMsg = " agregar el " & Me.msgElemento & " : " & Me.TxtCodigoPuntoPago.Text
        End Select
        sMsg = "Deseas " & sMsg & " ?"
    ...
    Private Sub tsbImprimirListado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbImprimirListado.Click
        Me.oPuntoPago.Imprimir_Listado()
    End Sub
#End Region
...
#Region "Métodos y procedimientos"
    ...
    Private Sub Cambia_Estado()
        Select Case Me.Estado
            Case enumEstados.NUEVO
                ...
                Me.TxtCodigoPuntoPago.Enabled = False
                Me.TxtNombrePuntoPago.Enabled = True
                Me.CboEstatus.Enabled = False
                Me.InicializaElemento()
                Me.TxtCodigoPuntoPago.Focus()
    ...
    Private Sub DesplegarElementos()
        ...
        With Me.Grid
            ...
            .Columns("CODIGO_PUNTO_PAGO").Width = 50
            .Columns("NOMBRE_PUNTO_PAGO").Width = 200
        End With
    End Sub

    Private Sub LlenaElemento(ByVal iCodigo_Elemento As String)
        Dim sCodigo As String
        Me.oPuntoPago.CODIGO_PUNTO_PAGO = CInt(iCodigo_Elemento)
        If Me.oPuntoPago.Consultar Then
            With Me.oPuntoPago
                sCodigo = "0000" + iCodigo_Elemento
                Me.TxtCodigoPuntoPago.Text = sCodigo.Substring(Len(sCodigo) - 4)
                Me.TxtNombrePuntoPago.Text = .NOMBRE_PUNTO_PAGO.ToString
                Me.txtDesde.Text = .DESDE.ToString
    ...
    Private Sub Grabar_Elemento()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO, enumEstados.EDICION
                ...
                Try
                    With Me.oPuntoPago
                        .CODIGO_PUNTO_PAGO = CInt(Me.TxtCodigoPuntoPago.Text)
                        .NOMBRE_PUNTO_PAGO = Me.TxtNombrePuntoPago.Text
                        ...
                        If Grabado Then
                            ...
                            If Me.Estado = enumEstados.NUEVO Then
                                Me.TxtCodigoPuntoPago.Text = .CodigoSiguiente.ToString
                            End If
                        End If
                    End With
                Catch ex As Exception
...
#Region "Eventos de la lista de elementos"
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_PUNTO_PAGO").Value.ToString)
    End Sub
...
#Region " Eventos de TxtFiltro"
    ...
    Private Sub txtFiltro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFiltro.KeyDown
        Dim oElementosFiltro As New Class_CatPuntoPago
...
#Region "Eventos Genericos"
    ...
    Private Sub CboEstatus_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles CboEstatus.KeyDown
        ...
        End If
    End Sub
    Private Sub txt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CboEstatus.KeyPress, _
    TxtNombrePuntoPago.KeyPress, txtCodigoSiguiente.KeyPress, txtDesde.KeyPress, txtHasta.KeyPress, cboGeneraDenominacion.KeyPress
        txtNoBeep(e)
    End Sub

    Private Sub TxtNombrePuntoPago_Keydown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtNombrePuntoPago.KeyDown
        If e.KeyCode = Keys.Return Then
            Me.txtDesde.Focus()
        End If
    End Sub
    ...
    Private Sub txtHasta_Keydown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtHasta.KeyDown
        If e.KeyCode = Keys.Return Then
            Me.txtCodigoSiguiente.Focus()
        End If
    End Sub

    Private Sub txtCodigoSiguiente_Keydown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCodigoSiguiente.KeyDown
        If e.KeyCode = Keys.Return Then
            Me.cboGeneraDenominacion.Focus()
        End If
    End Sub

    Private Sub cboGeneraDenominacion_Keydown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboGeneraDenominacion.KeyDown
        If e.KeyCode = Keys.Return Then
            Select Case Me.Estado
                Case enumEstados.EDICION
                    Me.CboEstatus.Focus()
    ...
    Private Sub txtNumericos_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtCodigoPuntoPago.KeyPress
