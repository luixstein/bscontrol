...
Public Class Catalogo_Conceptos
    Private oConcepto As New Class_CatConceptos
...
#Region "Métodos y procedimientos"
    ...
    Private Sub DesplegarElementos()
        Try
            With Me.Grid
                .DataSource = oConcepto.ObtenerElementos
                .Columns("CODIGO_CONCEPTO").Width = 50
                .Columns("NOMBRE_CONCEPTO").Width = 200
            End With
        Catch ex As Exception
    ...
    Private Sub LlenaElemento(ByVal sCodigo_Elemento As String)
        Try
            Me.oConcepto.Codigo_Concepto = sCodigo_Elemento
            If Me.oConcepto.Consultar Then
                With Me.oConcepto
                    Me.TxtCodigo.Text = .Codigo_Concepto.ToString
                    Me.TxtNombre.Text = .Nombre_Concepto.ToString
                    If .Estatus = "A" Then
                        Me.CboEstatus.SelectedIndex = 0
                    Else
    ...
    Private Sub Grabar()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO, enumEstados.EDICION
                Try
                    With Me.oConcepto
                        .Codigo_Concepto = Me.TxtCodigo.Text
                        .Nombre_Concepto = Me.TxtNombre.Text
...
#Region "Eventos de la lista de elementos"
    ...
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_CONCEPTO").Value.ToString)
    End Sub
