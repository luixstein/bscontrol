...
Public Class Catalogo_Divisiones_Acuicola
    Private oDivision As New Class_CatDivisionesAcuicola
...
#Region "Constructor y destructor"
    ...
    Sub New()
        ...
        Try
            Me.msgElemento = "Division"
            Me.msgElementos = "Divisiones"
            Me.Run = False
...
#Region "Opciones"
    Private Sub tsbNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNuevo.Click
        ...
        Me.Cambia_Estado()
        Me.TxtCodigo.Text = Me.oDivision.CodigoSiguiente
...
#Region "Métodos y procedimientos"
    ...
    Private Sub DesplegarElementos()
        Try
            With Me.Grid
                .DataSource = oDivision.ObtenerElementos
    ...
    Private Sub LlenaElemento(ByVal sCodigo_Elemento As String)
        Try
            Me.oDivision.Codigo_Division = sCodigo_Elemento
            If Me.oDivision.Consultar Then
                With Me.oDivision
                    Me.TxtCodigo.Text = .Codigo_Division.ToString
                    Me.TxtNombre.Text = .Nombre_Division.ToString
                    If .Estatus = "A" Then
                        Me.CboEstatus.SelectedIndex = 0
                    Else
    ...
    Private Sub Grabar()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO, enumEstados.EDICION
                Try
                    With Me.oDivision
                        .Codigo_Division = Me.TxtCodigo.Text
                        .Nombre_Division = Me.TxtNombre.Text
    ...
    Private Function Validar() As Boolean
        ...
        Try
            If txtLEN(Me.TxtNombre.Text) = False Then
                MsgBox("Captúre el nombre de la division.", MsgBoxStyle.Exclamation, Me.Text)
                Me.TxtNombre.Focus()
                Return False
            End If
...
#Region "Eventos de la lista de elementos"
    ...
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_DIVISION").Value.ToString)
    End Sub
...
#Region " Eventos de TxtFiltro"
    ...
    Private Sub txtFiltro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFiltro.KeyDown
        Dim oElementosFiltro As New Class_CatDivisionesAcuicola
