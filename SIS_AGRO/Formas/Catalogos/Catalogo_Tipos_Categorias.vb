...
Public Class Catalogo_Tipos_Categorias
    Private oTipoCategoria As New Class_CatTiposCategorias
...
#Region "Constructor y destructor"
    ...
    Sub New()
        ...
        Try
            Me.msgElemento = "Tipo categoria"
            Me.msgElementos = "Tipo categorias"
            Me.Run = False
...
#Region "Opciones"
    ...
    Private Sub tsbImprimirListado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbImprimirListado.Click
        Me.oTipoCategoria.Imprimir_Listado()
    End Sub
#End Region
...
#Region "Métodos y procedimientos"
    ...
    Private Sub DesplegarElementos()
        With Me.Grid
            .DataSource = oTipoCategoria.ObtenerElementosFiltro(Me.txtFiltro.Text, Me.cboEstatusFiltro.Text)
            .Columns("CODIGO_TIPO_CATEGORIA").Width = 50
    ...
    Private Sub LlenaElemento(ByVal sCodigo_Elemento As String)
        Me.oTipoCategoria.Codigo_Tipo_Categoria = sCodigo_Elemento
        If Me.oTipoCategoria.Consultar Then
            With Me.oTipoCategoria
                Me.TxtCodigo.Text = .Codigo_Tipo_Categoria.ToString
                Me.TxtNombre.Text = .Nombre_Tipo_Categoria.ToString
                If .Estatus = "A" Then
                    Me.CboEstatus.SelectedIndex = 0
                Else
    ...
    Private Sub Grabar_Elemento()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO, enumEstados.EDICION
                Try
                    With Me.oTipoCategoria
                        .Codigo_Tipo_Categoria = Me.TxtCodigo.Text
                        .Nombre_Tipo_Categoria = Me.TxtNombre.Text
...
#Region "Eventos de la lista de elementos"
    ...
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_TIPO_CATEGORIA").Value.ToString)
    End Sub
...
#Region "Eventos Genericos"
    ...
    Private Sub txt_Keydown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtCodigo.KeyDown, TxtNombre.KeyDown
        txtTAB(e)
    End Sub
