...
Public Class Catalogo_TiposTamaños
    Private oTipoTamaño As New Class_CatTiposTamaños
...
#Region "Opciones"
    Private Sub tsbNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNuevo.Click
        ...
        Me.Cambia_Estado()
        Me.TxtCodigoTipoTamaño.Text = Me.oTipoTamaño.CodigoSiguiente
    End Sub
    ...
    Private Sub tsbGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbGrabar.Click
        ...
        Select Case Me.Estado
            Case enumEstados.EDICION
                sMsg = " grabar las modificaciones del " & Me.msgElemento & " : " & Me.TxtCodigoTipoTamaño.Text
            Case enumEstados.NUEVO
                sMsg = " agregar el " & Me.msgElemento & " : " & Me.TxtCodigoTipoTamaño.Text
        End Select
        sMsg = "Deseas " & sMsg & " ?"
    ...
    Private Sub tsbImprimirListado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbImprimirListado.Click
        Me.oTipoTamaño.Imprimir_Listado()
    End Sub
#End Region
...
#Region "Métodos y procedimientos"
    ...
    Private Sub Cambia_Estado()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO
                ...
                Me.TxtCodigoTipoTamaño.Enabled = False
                Me.TxtNombreTipoTamaño.Enabled = True
                Me.CboEstatus.Enabled = False

                Me.InicializaElemento()
                Me.TxtNombreTipoTamaño.Focus()
    ...
    Private Sub InicializaElemento()
        Me.TxtCodigoTipoTamaño.Text = ""
        Me.TxtNombreTipoTamaño.Text = ""
    ...
    Private Sub DesplegarElementos()
        With Me.lstbElementos
            ...
            Dim dView As New Data.DataView(Me.oTipoTamaño.ObtenerElementos)
    ...
    Private Sub LlenaElemento(ByVal sCodigo_Elemento As String)
        Me.oTipoTamaño.CODIGO_TIPO_TAMAÑO = sCodigo_Elemento
        If Me.oTipoTamaño.Consultar Then
            With Me.oTipoTamaño
                Me.TxtCodigoTipoTamaño.Text = .CODIGO_TIPO_TAMAÑO.ToString
                Me.TxtNombreTipoTamaño.Text = .NOMBRE_TIPO_TAMAÑO.ToString
    ...
    Private Sub Grabar_Elemento()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO, enumEstados.EDICION
                Try
                    With Me.oTipoTamaño
                        .CODIGO_TIPO_TAMAÑO = Me.TxtCodigoTipoTamaño.Text
                        .NOMBRE_TIPO_TAMAÑO = Me.TxtNombreTipoTamaño.Text
...
#Region "Eventos Genericos"
    ...
    Private Sub CboEstatus_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles CboEstatus.KeyDown
        ...
        End If
    End Sub
    Private Sub txt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CboEstatus.KeyPress, TxtNombreTipoTamaño.KeyPress
        txtNoBeep(e)
    End Sub

    Private Sub txt_Keydown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtNombreTipoTamaño.KeyDown
        If e.KeyCode = Keys.Return Then
            Select Case Me.Estado
                Case enumEstados.EDICION
                    SendKeys.Send("{TAB}")
    ...
    Private Sub txtNumericos_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtCodigoTipoTamaño.KeyPress
