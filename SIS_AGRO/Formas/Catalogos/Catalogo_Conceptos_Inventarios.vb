...
Public Class Catalogo_Conceptos_Inventarios
    Private oConceptoInventario As New Class_CatConceptosInventarios
...
#Region "Constructor y destructor"
    ...
    Sub New()
        ...
        Try
            Me.msgElemento = "Concepto de inventario"
            Me.msgElementos = "Conceptos de inventarios"
            Me.Run = False
...
#Region "Opciones"
    Private Sub tsbNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNuevo.Click
        ...
        Me.Cambia_Estado()
        Me.TxtCodigo.Text = Me.oConceptoInventario.CodigoSiguiente
    End Sub
    ...
    Private Sub tsbImprimirListado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbImprimirListado.Click
        Me.oConceptoInventario.Imprimir_Listado()
    End Sub
#End Region
...
#Region "Métodos y procedimientos"
    ...
    Private Sub DesplegarElementos()
        Try
            With Me.Grid
                .DataSource = oConceptoInventario.ObtenerElementos
                .Columns("CODIGO_CONCEPTO_INVENTARIOS").Width = 50
                .Columns("NOMBRE_CONCEPTO_INVENTARIOS").Width = 200
            End With
        Catch ex As Exception
    ...
    Private Sub LlenaElemento(ByVal sCodigo_Elemento As String)
        Try
            Me.oConceptoInventario.Codigo_Concepto_Inventarios = CInt(sCodigo_Elemento)
            If Me.oConceptoInventario.Consultar Then
                With Me.oConceptoInventario
                    Me.TxtCodigo.Text = .Codigo_Concepto_Inventarios.ToString
                    Me.TxtNombre.Text = .Nombre_Concepto_Inventarios.ToString
                End With
            End If
        Catch ex As Exception
    ...
    Private Sub Grabar()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO, enumEstados.EDICION
                Try
                    With Me.oConceptoInventario
                        .Codigo_Concepto_Inventarios = CInt(Me.TxtCodigo.Text)
                        .Nombre_Concepto_Inventarios = Me.TxtNombre.Text
                        Select Case Me.Estado
                            Case enumEstados.NUEVO
    ...
    Private Function Validar() As Boolean
        ...
        Try
            If txtLEN(Me.TxtNombre.Text) = False Then
                MsgBox("Captúre el nombre del concepto de inventario.", MsgBoxStyle.Exclamation, Me.Text)
                Me.TxtNombre.Focus()
                Return False
            End If
...
#Region "Eventos de la lista de elementos"
    ...
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_CONCEPTO_INVENTARIOS").Value.ToString)
    End Sub
...
#Region " Eventos de TxtFiltro"
    ...
    Private Sub txtFiltro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFiltro.KeyDown
        Dim oElementosFiltro As New Class_CatConceptosInventarios
