...
Public Class Catalogo_Conceptos_Fletes_Equipo
    Private oConcepto As New Class_CatConceptoFleteEquipo
...
#Region "Constructor y destructor"
    ...
    Sub New()
        ...
        Try
            Me.msgElemento = "Concepto"
            Me.msgElementos = "Conceptos"
            Me.Run = False
...
#Region "Opciones"
    Private Sub tsbNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbNuevo.Click
        ...
        Me.Cambia_Estado()
        Me.TxtCodigo.Text = Me.oConcepto.CodigoSiguiente
    End Sub
...
#Region "Métodos y procedimientos"
    ...
    Private Sub DesplegarElementos()
        With Me.Grid
            .DataSource = Me.oConcepto.ObtenerElementos
            .Columns("CODIGO_CONCEPTO_FLETE_EQUIPO").Width = 150
            .Columns("NOMBRE_CONCEPTO_FLETE_EQUIPO").Width = 200
        End With

    End Sub

    Private Sub LlenaElemento(ByVal sCodigo_Elemento As String)
        Me.oConcepto.Codigo_Concepto_flete_equipo = sCodigo_Elemento
        If Me.oConcepto.Consultar Then
            With Me.oConcepto
                Me.TxtCodigo.Text = .Codigo_Concepto_flete_equipo.ToString
                Me.TxtNombre.Text = .Nombre_Concepto_flete_equipo.ToString
                If .Estatus = "A" Then
                    Me.CboEstatus.SelectedIndex = 0
                Else
    ...
    Private Sub Grabar_Elemento()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO, enumEstados.EDICION
                Try
                    With Me.oConcepto
                        .Codigo_Concepto_flete_equipo = Me.TxtCodigo.Text
                        .Nombre_Concepto_flete_equipo = Me.TxtNombre.Text
...
#Region "Eventos de Grid"
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_CONCEPTO_FLETE_EQUIPO").Value.ToString)
    End Sub
...
#Region " Eventos de TxtFiltro"
    Private Sub txtFiltro_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtFiltro.TextChanged
        Dim oElementos As New Class_CatConceptoFleteEquipo
    ...
    Private Sub txtFiltro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFiltro.KeyDown
        Dim oElementosFiltro As New Class_CatConceptoFleteEquipo
