...
Public Class Catalogo_Concepto_Costos_Produccion
    Private oConcepto As New Class_CatConceptoCostosProduccion
...
#Region "Métodos y procedimientos"
    ...
    Private Sub DesplegarElementos()
        With Me.Grid
            ...
            .Columns("CODIGO_CONCEPTO_COSTO_PRODUCCION").Width = 150
            .Columns("NOMBRE_CONCEPTO_COSTO_PRODUCCION").Width = 200
        End With

    End Sub

    Private Sub LlenaElemento(ByVal sCodigo_Elemento As String)
        Me.oConcepto.Codigo_Concepto_costo_produccion = sCodigo_Elemento
...
#Region "Eventos de la lista de elementos"
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_CONCEPTO_COSTO_PRODUCCION").Value.ToString)
    End Sub
...
#Region " Eventos de TxtFiltro"
    ...
    Private Sub txtFiltro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtFiltro.KeyDown
        Dim oElementosFiltro As New Class_CatConceptoCostosProduccion
