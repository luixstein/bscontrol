...
Public Class Frm_Contabilidad_Costo_corte_acarreo_empaque_embarque
    ...
    Private Sub Imprimir()
        ...
        Try
            ...
            If Me.RdbTotalEmpresa.Checked = True Then
                oReporte = New Class_Reporte("RPT_COSTO_CORTE_ACARREO_EMPAQUE_EMBARQUE", Rpt)
            Else
                oReporte = New Class_Reporte("RPT_COSTO_CORTE_ACARREO_EMPAQUE_EMBARQUE_TARRIBA_" & Me.CmbEjercicio.Text, Rpt)
            End If
...
#End Region
    ...
    Private Sub Frm_Contabilidad_Costos_Produccion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Usuario.Codigo_Usuario = 16 Then 'para que rosario de tarriba no pueda sacar el otro reporte
