...
Public Class Frm_Contabilidad_Comparativas_Financieras
...
#Region "Opciones"
    Private Sub tsbConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Me.ValidarPeriodo() And Me.ValidarPeriodo2 Then
            Me.Imprimir()
        End If
        'End If
    End Sub
...
#Region "Métodos y procedimientos"
    ...
    Private Function ValidarPeriodo() As Boolean
        If Me.DtFechaDesde.Value > Me.DtFechaHasta.Value Then
            ...
            Exit Function
        End If
        Dim ValidaPeriodo As New Class_find("SELECT 1 FROM CON_EJERCICIOS WHERE (('" & Format(Me.DtFechaDesde.Value, "yyyy-dd-MM") & "' BETWEEN FECHA_INICIO AND FECHA_FINAL)) AND (('" & Format(Me.DtFechaHasta.Value, "yyyy-dd-MM") & "' BETWEEN FECHA_INICIO AND FECHA_FINAL)) AND ID_CON_EJERCICIO=" & Me.CmbEjercicio1.SelectedValue.ToString)
    ...
    Private Sub CmbEjercicio1_SelectedIndexChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmbEjercicio1.SelectedIndexChanged
        Dim sql As Class_find
        sql = New Class_find("SELECT FECHA_INICIO,FECHA_FINAL FROM CON_EJERCICIOS WHERE ID_CON_EJERCICIO=" & Me.CmbEjercicio1.SelectedValue.ToString)
    ...
    Private Sub Imprimir()
        ...
        Try
            If RdbRelacionAnalitica.Checked = True Then
                FormatoDeReporte = "RPT_CONTABILIDAD_RELACIONES_ANALITICAS_COMPARATIVAS"
            End If

            If RdbBalanzaComprobacion.Checked = True Then
                FormatoDeReporte = "RPT_CONTABILIDAD_ESTADO_CAMBIOS_SITUACION_FINANCIERA"
            End If
            ...
            Rpt.SetParameterValue("@ID_CON_EJERCICIO_A", Me.CmbEjercicio1.SelectedValue)
    ...
    Private Sub Limpiar()
        Me.TxtCuenta1.Text = ""
        Me.TxtCuenta2.Text = ""
        Me.CmbEjercicio1.SelectedValue = Plaza.ID_CON_EJERCICIO - 1
        Me.DtFechaDesde.Value = Plaza.FECHA_INICIO
        Me.DtFechaHasta.Value = Plaza.FECHA_FINAL
        Me.CmbEjercicio2.SelectedValue = Plaza.ID_CON_EJERCICIO
...
#Region "Eventos Genericos"
    ...
    Private Sub txtKeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtCuenta1.KeyPress, TxtCuenta2.KeyPress, DtFechaDesde.KeyPress, DtFechaHasta.KeyPress
        txtNoBeep(e)
