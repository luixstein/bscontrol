...
Public Class Frm_Embarques_ConfiguracionEquivalenciasEnvases
    Private oEquivalencia As New Class_Embarques_ConfiguracionEquivalenciasEnvases
...
#End Region
    ...
    Private iGyCodigoTipoEnvase As Integer = 2
    Private iGyNombreTipoEnvase As Integer = 3
    Private iGyEquivalencia As Integer = 4
...
#Region "Constructor y destructor"
    ...
    Sub New()
        ...
        Try
            Me.msgElemento = "Equivalencia"
            Me.msgElementos = "Equivalencias"
            Me.Run = False
...
#Region "Opciones"
    ...
    Private Sub tsbImprimirListado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbImprimirListado.Click
        Me.oEquivalencia.Imprimir_Listado()
    End Sub
#End Region
...
#Region "Eventos de la lista de elementos"
    ...
    Private Sub Grid_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grid.CellClick
        Me.LlenaElemento(Me.Grid.CurrentRow.Cells("CODIGO_CULTIVO").Value.ToString, CInt(Me.Grid.CurrentRow.Cells("CODIGO_TIPO_ENVASE").Value))
    End Sub
...
#Region " Eventos de TxtFiltro"
    Private Sub txtFiltro_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtfiltro.TextChanged
        Dim oElementos As New Class_Embarques_ConfiguracionEquivalenciasEnvases
    ...
    Private Sub txtFiltro_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        ...
        txtNoComilla(e)
    End Sub
    Private Sub txtFiltro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        Dim oElementosFiltro As New Class_Embarques_ConfiguracionEquivalenciasEnvases
...
#Region "Eventos Genericos"
    ...
    Private Sub txtTextoKeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtEquivalencia.KeyPress
        txtNoBeep(e)
    End Sub
    ...
    Private Sub txtNumerosDecimalKeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtEquivalencia.KeyPress
        Dim txt As TextBox = CType(sender, TextBox)
        txtSoloNumerosDecimales(e, txt.Text)
        txtNoBeep(e)
    End Sub

    Private Sub Cbo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboCultivo.KeyDown, CboTipoEnvase.KeyDown
...
#Region "Keydown específicos"
    ...
    Private Sub TxtEquivalencia_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtEquivalencia.KeyDown
        If e.KeyCode = Keys.Return Then
            Me.TxtEquivalencia.Text = FormatNumber(CDbl(Me.TxtEquivalencia.Text), 2)
...
#Region "Métodos y procedimientos"
    ...
    Private Sub Cambia_Estado()
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO
                ...
                Me.TxtEquivalencia.Enabled = True
    ...
    Private Sub FormateaGrid()
        ...
        Me.Grid.Columns(Me.iGyNombreCultivo).Width = 300
        Me.Grid.Columns(Me.iGyNombreTipoEnvase).Width = 100
    End Sub
    ...
    Private Sub DesplegarElementos()
        ...
        With Me.Grid
            ...
            .Columns("CULTIVO").Width = 300
            .Columns("CODIGO_TIPO_ENVASE").Width = 100
            .Columns("ENVASE").Width = 150
            .Columns("EQUIVALENCIA").Width = 100
        End With
    End Sub
    ...
    Private Sub LlenaElemento(ByVal iCodigo_Cultivo As String, ByVal iCodigo_Tipo_Envase As Integer)
        Dim oElemento As New Class_Embarques_ConfiguracionEquivalenciasEnvases
        oElemento.CODIGO_CULTIVO = iCodigo_Cultivo
        oElemento.CODIGO_TIPO_ENVASE = iCodigo_Tipo_Envase
        If oElemento.Consultar Then
            With oElemento

                Dim oSubCuentas As New Class_find("Select CODIGO_CULTIVO, CODIGO_TIPO_ENVASE,EQUIVALENCIA FROM EMB_CONFIGURACION_EQUIVALENCIA_ENVASE " & _
                ...
                Me.TxtEquivalencia.Text = .EQUIVALENCIA.ToString
            End With
        End If
        oElemento = Nothing
    ...
    Private Sub Grabar_Elemento()
        ...
        If txtLEN(Me.TxtEquivalencia.Text) = False Then
            MsgBox("Captúre un valor de equivalencia.", MsgBoxStyle.Information, Me.Name)
            Exit Sub
        End If
        ...
        Select Case Me.Estado
            Case enumEstados.NUEVO, enumEstados.EDICION
                Me.oEquivalencia = New Class_Embarques_ConfiguracionEquivalenciasEnvases
                Try
                    With Me.oEquivalencia
                        .CODIGO_CULTIVO = Me.cboCultivo.SelectedValue.ToString
                        .CODIGO_TIPO_ENVASE = CInt(Me.CboTipoEnvase.SelectedValue)
                        .EQUIVALENCIA = CDbl(Me.TxtEquivalencia.Text)
                        Select Case Me.Estado
                            Case enumEstados.NUEVO
                                If .Insertar() Then
                                    Grabado = True
