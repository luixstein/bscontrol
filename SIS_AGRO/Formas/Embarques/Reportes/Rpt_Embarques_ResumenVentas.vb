...
Public Class Rpt_Embarques_ResumenVentas
    ...
    Private Sub Consultar()
        ...
        Try
            ...
            If Me.RdbCliente.Checked = True Then
                FormatoDeReporte = "RPT_VENTAS_RESUMEN_EXTRANJERO_NACIONAL_CLIENTE"
            Else
                FormatoDeReporte = "RPT_VENTAS_RESUMEN_EXTRANJERO_NACIONAL_CULTIVO"
            End If
            ...
            Rpt.SetParameterValue("@CODIGO_MERCADO_EXTRANJERO_MODULO_EMBARQUES", "E")
            Rpt.SetParameterValue("@CODIGO_TIPO_MERCADO_NACIONAL_MODULO_VENTAS", "0002")
            Rpt.SetParameterValue("@UNIDAD_VENTA", "") '--NO SE USA EN ESTE REPORTE PERO SI EN EL SUBREPORTE DE LO NACIONAL, SE PASA EN BLANCO, SE OCUPA PARA PODER VINCULARLO EN CRISTAL
    ...
    cboCultivo.KeyPress, cboCultivo.KeyPress, TxtCliente.KeyPress, CboSemana1.KeyPress, CboSemana2.KeyPress
        txtNoBeep(e)
    End Sub
    ...
    Private Sub TxtCliente_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtCliente.KeyDown
        ...
        Select Case e.KeyCode
            Case Keys.F6
Buscar:
                sText = Me.oClientes.BusquedaVisual_PorDescripcionZona("T")
