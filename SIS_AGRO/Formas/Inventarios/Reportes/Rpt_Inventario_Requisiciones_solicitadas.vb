...
Public Class Rpt_Inventario_Requisiciones_Solicitadas
...
#Region "Métodos y procedimientos"
    ...
    Private Sub Consultar()
        ...
        Try
            FormatoDeReporte = "RPT_INVENTARIOS_REQUISICIONES_SOLICITADAS"
        ...
        Catch ex As Exception
            HandleError(Me.Name, "Reporte de requisiciones solicitadas", ex)
        Finally
            oReporte = Nothing
        End Try
    End Sub
