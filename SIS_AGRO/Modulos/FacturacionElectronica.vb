...
#End Region
    ...
    Public Function Timbrar(ByVal sFolioDocumentoSistema As String, ByVal sRutaXML As String, ByVal tipoComprobante As TipoComprobante)
        ...
        Try
            If My.Computer.Name = "PCSISTEMASJORGE" Or My.Computer.Name = "PCSISTEMASJGC22" Or My.Computer.Name = "ERNESTOA" Or My.Computer.Name = "DANIEL-PC" Or Usuario.Codigo_Usuario = 1 Then
