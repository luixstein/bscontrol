...
#Region "Métodos y procedimientos"
    ...
    Public Function ObtenerDetalleOrdenCompra() As DataTable
        ...
        sSQL = "SELECT R.CODIGO_ARTICULO,R.DESCRIPCION,R.DISPONIBLE,R.PRECIO,R.PRECIO_USD,R.COSTO,R.UNIDAD_VENTA,R.IMPUESTO_PORCENTAJE,R.IMPORTE,R.IMPORTE_USD,R.CUENTA_CONTABLE,R.IMPUESTO_IMPORTE,R.IMPUESTO_IMPORTE_USD,R.ID_COMPRA_DETALLE, " &
            ...
            "R.IEPS_PORCENTAJE,R.IEPS_UNITARIO,R.IEPS_UNITARIO_USD,R.IEPS_IMPORTE,R.IEPS_IMPORTE_USD,R.BASE_IEPS,R.BASE_IEPS_USD,R.BASE_IVA,R.BASE_IVA_USD,R.ID_INVENTARIO_MOVIMIENTOS_DETALLE_ENTRADA,0,0 " &
            "FROM COMPRA_DETALLE R " &
            "WHERE R.FOLIO_COMPRA='" & Me._FOLIO_COMPRA & "' " &
            "AND R.DISPONIBLE>0 " &
            "ORDER BY R.ID_COMPRA_DETALLE " 'NOTA NO SE DEBE ORDENAR POR DESCRIPCION PORQUE NOS VA MOVER EL IDADICIONAL PARA LO DEL CENTRO DE COSTOS
    ...
    Public Function ObtenerDetalleCostos() As DataTable
        ...
        sSQL = "SELECT '' TIPO,R.CODIGO_CENTRO_COSTO,CC.NOMBRE_CENTRO_COSTO,R.CODIGO_CATEGORIA,CA.NOMBRE_CATEGORIA,R.CODIGO_CONCEPTO,CO.NOMBRE_CONCEPTO,R.IMPORTE,R.IVA_IMPORTE,R.TOTAL,R.CUENTA_CONTABLE,R.UUID,'','','','',R.ID_CENTRO_COSTOS_MOVIMIENTOS_DETALLE " &
    ...
    Public Function ObtenerDetalleGastosActivos() As DataTable
        ...
        sSQL = "SELECT R.CUENTA_CONTABLE,DBO.FN_CONTABILIDAD_NOMBRE_CUENTA_NIVELES_COMPLETOS(R.CUENTA_CONTABLE) NOMBRE_CUENTA_NIVELES_COMPLETOS,R.IMPORTE,R.IVA_IMPORTE,R.TOTAL,R.UUID,'','','','',R.ID_GASTOS_DETALLE " &
