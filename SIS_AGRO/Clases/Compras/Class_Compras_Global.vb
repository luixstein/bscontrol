...
#Region "Métodos y procedimientos"
    ...
    Public Function ObtenerDetalleCostos() As DataTable
        ...
        sSQL = "SELECT '' TIPO,R.CODIGO_CENTRO_COSTO,CC.NOMBRE_CENTRO_COSTO,R.CODIGO_CATEGORIA,CA.NOMBRE_CATEGORIA,R.CODIGO_CONCEPTO,CO.NOMBRE_CONCEPTO,R.IMPORTE,R.IVA_IMPORTE,R.TOTAL,R.CUENTA_CONTABLE,R.UUID,'','','','' " &
    ...
    Public Function ObtenerDetalleGastosActivos() As DataTable
        ...
        sSQL = "SELECT R.CUENTA_CONTABLE,DBO.FN_CONTABILIDAD_NOMBRE_CUENTA_NIVELES_COMPLETOS(R.CUENTA_CONTABLE) NOMBRE_CUENTA_NIVELES_COMPLETOS,R.IMPORTE,R.IVA_IMPORTE,R.TOTAL,R.UUID,'','','','' " &
