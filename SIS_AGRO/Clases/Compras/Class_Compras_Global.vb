...
#Region "Campos de la tabla"
    ...
    Private _CODIGO_ARTICULO_GASTOS As String
#End Region
...
#Region "Propiedades Campos de la tabla"
    ...
    Public Property CODIGO_ARTICULO_GASTOS() As String
        Get
            Return Me._CODIGO_ARTICULO_GASTOS
        End Get
        Set(value As String)
            Me._CODIGO_ARTICULO_GASTOS = value
        End Set
    End Property
...
#Region "Métodos y procedimientos"
    ...
    Public Function GrabaCompraGlobalSinOrden(ByVal sListaCentrosCostos As String, ByVal sListaActivos As String) As Boolean
        ...
        With cmd
            ...
            sqlParametro = .Parameters.Add("@RETENCION_IVA", SqlDbType.Decimal) : sqlParametro.Value = Me._RETENCION_IVA
            sqlParametro = .Parameters.Add("@RETENCION_ISR", SqlDbType.Decimal) : sqlParametro.Value = Me._RETENCION_ISR
            sqlParametro = .Parameters.Add("@IEPS", SqlDbType.Decimal) : sqlParametro.Value = Me._IEPS_TOTAL_DESGLOSADO
            sqlParametro = .Parameters.Add("@IMPUESTO_PORCENTAJE", SqlDbType.Decimal) : sqlParametro.Value = Me._IMPUESTO_PORCENTAJE
            ...
            sqlParametro = .Parameters.Add("@CODIGO_ARTICULO_GASTOS", SqlDbType.NVarChar, 16) : sqlParametro.Value = Me._CODIGO_ARTICULO_GASTOS.ToUpper
        ...
        With cmd
            ...
            Try
                ...
                If dReader.Read Then
                    ...
                    Me._CODIGO_ARTICULO_GASTOS = "" & dReader("CODIGO_ARTICULO_GASTOS").ToString
    ...
    Public Function ObtenerDetalle() As DataTable
        ...
        sSQL = "With DC(ID_ADICIONAL, CUENTA_CONTABLE) " &
                ...
                "SELECT R.CODIGO_ARTICULO,R.DESCRIPCION,R.CANTIDAD,R.PRECIO,R.PRECIO_USD,R.COSTO,R.UNIDAD_VENTA,R.IMPUESTO_PORCENTAJE,R.IMPORTE,R.IMPORTE_USD,R.MARGEN_UTILIDAD,R.COSTO_MERCADO,R.PRECIO_VENTA,R.CUENTA_CONTABLE,R.IMPUESTO_IMPORTE,R.IMPUESTO_IMPORTE_USD,R.ID_COMPRA_DETALLE, " &
    ...
    Public Function ObtenerDetalleCostos() As DataTable
        ...
        sSQL = "SELECT '' TIPO,R.CODIGO_CENTRO_COSTO,CC.NOMBRE_CENTRO_COSTO,R.CODIGO_CATEGORIA,CA.NOMBRE_CATEGORIA,R.CODIGO_CONCEPTO,CO.NOMBRE_CONCEPTO,R.IMPORTE,R.IVA_IMPORTE,R.RETENCION_IVA,R.RETENCION_ISR,R.IEPS,R.TOTAL," &
                "R.CUENTA_CONTABLE,R.UUID,'' XML,'' PDF,'' RutaXML,'' RutaPDF,R.ID_CENTRO_COSTOS_MOVIMIENTOS_DETALLE," &
                "R.CUENTA_CONTABLE_IVA_RETENIDO,R.CUENTA_CONTABLE_ISR_RETENIDO,R.CUENTA_CONTABLE_IEPS,R.EMISOR_NOMBRE,R.EMISOR_RFC " &
    ...
    Public Function ObtenerDetalleGastosActivos() As DataTable
        ...
        sSQL = "SELECT R.CUENTA_CONTABLE,DBO.FN_CONTABILIDAD_NOMBRE_CUENTA_NIVELES_COMPLETOS(R.CUENTA_CONTABLE) NOMBRE_CUENTA_NIVELES_COMPLETOS,R.IMPORTE,R.IVA_IMPORTE,R.IVA_IMPORTE,R.RETENCION_IVA,R.RETENCION_ISR,R.IEPS,R.TOTAL," &
                "R.UUID,'' XML,'' PDF,'' RutaXML,'' RutaPDF,R.ID_GASTOS_DETALLE," &
                "R.CUENTA_CONTABLE_IVA_RETENIDO,R.CUENTA_CONTABLE_ISR_RETENIDO,R.CUENTA_CONTABLE_IEPS,R.EMISOR_NOMBRE,R.EMISOR_RFC " &
