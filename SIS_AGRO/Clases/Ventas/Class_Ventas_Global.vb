...
#Region "Métodos y procedimientos"
    ...
    Public Function ObtenerDetalle(Optional ByVal bSinComentarios As Boolean = True) As DataTable
        ...
        Try
            sSQL = "SELECT R.CODIGO_ARTICULO, " & _
                ...
                "R.IEPS_PORCENTAJE,R.IEPS_UNITARIO,R.IEPS_IMPORTE,R.BASE_IEPS,R.BASE_IVA,R.COSTO,(R.PRECIO - R.COSTO) UTILIDAD,CASE WHEN R.PRECIO > 0 THEN ((R.PRECIO-R.COSTO)/R.PRECIO) ELSE 0 END UTILIDA_PORCENTAJE " & _
    ...
    Public Function ObtenerDetalleSoloDisponibles() As DataTable
        ...
        Try
            ...
            "R.IEPS_PORCENTAJE,R.IEPS_UNITARIO,R.IEPS_IMPORTE,R.BASE_IEPS,R.BASE_IVA,R.PRECIO_TOTAL,R.COSTO,(R.PRECIO - R.COSTO) UTILIDAD,CASE WHEN R.PRECIO > 0 THEN ((R.PRECIO-R.COSTO)/R.PRECIO) ELSE 0 END UTILIDA_PORCENTAJE " & _
            "FROM VENTA_DETALLE R " & _
            "INNER JOIN CAT_ARTICULOS A ON(R.CODIGO_ARTICULO=A.CODIGO_ARTICULO) " & _
