    ...
    Public Function ObtenerDetalle(Optional ByVal bSinComentarios As Boolean = True) As DataTable
        ...
        Try
            sSQL = "SELECT R.CODIGO_ARTICULO, " &
                ...
                "R.CUENTA_CONTABLE,R.IMPUESTO_IMPORTE,R.ID_VENTA_DETALLE ID_ORIGEN,R.ES_PRODUCTO_KILOS,R.CODIGO_CENTRO_COSTO,CC.NOMBRE_CENTRO_COSTO,R.PRECIO_USD,R.IMPORTE_USD, " &
                "R.IEPS_PORCENTAJE,R.IEPS_UNITARIO,R.IEPS_IMPORTE,R.BASE_IEPS,R.BASE_IVA,R.COSTO,0 IDA,R.CODIGO_ARTICULO CODIGO_ARTICULO_ANTERIOR,R.CANTIDAD CANTIDAD_ANTERIOR,'' BOTON_K,'' BOTON_L " &
