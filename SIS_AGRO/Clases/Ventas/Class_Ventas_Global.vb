...
#Region "Constructor y destructor"
    Public Sub New()
        ...
        Me._QuerySelect = "SELECT G.* " &
            ...
            "ISNULL((SELEC TOP 1 '1' FROM VENTA_DETALLE WHERE FOLIO_VENTA=G.FOLIO_VENTA AND LEN(LISTA_SERIES)>0),0) TIENE_SERIES " &
            "FROM VENTA_GLOBAL G " &
    ...
    Public Function ObtenerDetalle(Optional ByVal bSinComentarios As Boolean = True) As DataTable
        ...
        Try
            sSQL = "SELECT R.CODIGO_ARTICULO, " & _
                ...
                "R.IEPS_PORCENTAJE,R.IEPS_UNITARIO,R.IEPS_IMPORTE,R.BASE_IEPS,R.BASE_IVA,R.COSTO " & _
