...
Public Class Class_INE_CatEntidades
...
#Region "Constructor y destructor"
    ...
    Public Sub New(ByVal sCODIGO_ENTIDAD As String)
        Me.New()
        Try
            Me._CODIGO_ENTIDAD = sCODIGO_ENTIDAD
...
#Region "Métodos y procedimientos"
    ...
    Private Function Consultar() As Boolean
        ...
        sSQL = "SELECT CODIGO_ENTIDAD,NOMBRE_ENTIDAD FROM CFDI_INE_CAT_ENTIDADES WHERE CODIGO_ENTIDAD  =" & Me._CODIGO_ENTIDAD.ToString
        ...
        With cmd
            ...
            Try
                ...
                If dReader.Read = True Then
                    Me._CODIGO_ENTIDAD = "" & dReader("CODIGO_ENTIDAD").ToString()
                    Me._NOMBRE_ENTIDAD = "" & dReader("NOMBRE_ENTIDAD").ToString()
    ...
    Public Function ObtenerEntidades() As System.Data.DataTable
        Dim dTable As New DataTable
        Dim da As New SqlDataAdapter("SELECT CODIGO_ENTIDAD,NOMBRE_ENTIDAD FROM CFDI_INE_CAT_ENTIDADES", Me._Conexion)
        Try
            da.Fill(dTable)
        Catch ex As Exception
            HandleError(Me.NombreClase, "ObtenerEntidades", ex)
        Finally
            da.Dispose()
        End Try
        Return dTable
