...
Friend Class cComprobante33

    Private Const NombreClase As String = "cComprobante33"
...
#Region "Campos xml"
    ...
    Public Emisor As iEmisor33
    Public Receptor As iReceptor33
    Public Conceptos As iConceptos33
...
#Region "Métodos y procedimientos"
    ...
    Private Sub Class_Initialize_Renamed()
        Me.Emisor = New iEmisor33
        Me.Receptor = New iReceptor33
        Me.Conceptos = New iConceptos33
        Me.Impuestos = New iImpuestos33
        ...
        Me.AnexoNodo = "cfdi:"
        Me.xmlns = "http://www.sat.gob.mx/cfd/3"
        ...
        Try
            ...
            With NodoEmisor
                ...
                If txtLEN(Trim(Me.Emisor.Nombre)) = True Then
                    .setAttribute("Nombre", Trim(Me.Emisor.Nombre)) 'optional
                End If

                If txtLEN(Trim(Me.Emisor.RegimenFiscal)) = True Then
                    .setAttribute("RegimenFiscal", Trim(Me.Emisor.RegimenFiscal)) 'optional
                End If
            End With
            ...
            With NodoReceptor
                ...
                If txtLEN(Trim(Me.Receptor.Nombre)) = True Then
                    .setAttribute("Nombre", Trim(Me.Receptor.Nombre)) 'optional
                End If
    ...
    Private Function ValidaComprobante() As Boolean
        ...
        Try
            ...
            'MetodoPago
            If Not (Me.ComplementoPagos10 Is Nothing) Then 'Si le pasó el complemento de pagos
                If Me.ComplementoPagos10.ComplementoGenerado = True Then
                    If txtLEN(Me.MetodoPago) = True Then
