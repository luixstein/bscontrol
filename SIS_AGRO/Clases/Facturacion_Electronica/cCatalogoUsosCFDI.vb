...
Friend Class cCatalogoUsosCFDI
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cCatalogoUsosCFDI"

    Public Function Add(ByVal CODIGO_USO_CFDI As String, ByVal NOMBRE_USO_CFDI As String, ByVal ESTATUS As String, ES_DEFAULT As Boolean,
                    ByVal APLICA_TIPO_FISICA As Boolean, ByVal APLICA_TIPO_MORAL As Boolean) As cCatalogoUsoCFDI

        Const sProcedure As String = "Add"

        Dim objObjeto As New cCatalogoUsoCFDI
        Try
            With objObjeto
                .CODIGO_USO_CFDI = CODIGO_USO_CFDI
                .NOMBRE_USO_CFDI = NOMBRE_USO_CFDI
                .ESTATUS = ESTATUS
                .ES_DEFAULT = ES_DEFAULT
                .APLICA_TIPO_FISICA = APLICA_TIPO_FISICA
                .APLICA_TIPO_MORAL = APLICA_TIPO_MORAL
            End With

            Partidas.Add(objObjeto, CStr(CODIGO_USO_CFDI))
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cCatalogoUsoCFDI
        Get
