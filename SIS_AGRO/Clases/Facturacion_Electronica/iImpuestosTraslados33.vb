...
Friend Class iImpuestosTraslados33
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "iImpuestosTraslados33"

    Public Function Add(Impuesto As String, TipoFactor As String, TasaOCuota As String, Importe As String) As iImpuestosTraslado33

        Const sProcedure As String = "Add"

        Dim objObjeto As New iImpuestosTraslado33
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As iImpuestosTraslado33
        Get
