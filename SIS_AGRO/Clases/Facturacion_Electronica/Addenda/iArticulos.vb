...
Public Class iArticulos
    ...
    Public Function Add(ByVal codigoArticulo As String) As iArticulo ', ByVal Proveedor As String, ByVal Remision As String, ByVal FolioPedido As String, ByVal Tienda As String
        Dim objObjeto As New iArticulo
        Try
            objObjeto.Id = codigoArticulo
            objObjeto.RowOrder = Partidas.Count + 1
            objObjeto.Proveedor = Proveedor
            objObjeto.Remision = Remision
            objObjeto.FolioPedido = FolioPedido
            objObjeto.Tienda = Tienda

            objObjeto.Codigo = codigoArticulo
            objObjeto.CantidadUnidadCompra = CantidadUnidadCompra
            objObjeto.CostoNetoUnidadCompra = CostoNetoUnidadCompra
            objObjeto.PorcentajeIEPS = 0
            objObjeto.PorcentajeIVA = 0

            Partidas.Add(objObjeto, "N" & Partidas.Count + 1 & CStr(codigoArticulo))
        Catch ex As Exception
            HandleError("iArticulo", "Add", ex)
        End Try
        Return objObjeto
    End Function
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As iArticulo
        Get
