...
Friend Class cPagosDoctoRelacionados20
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cPagosDoctoRelacionados20"

    Public Function Add(ByVal IdDocumento As String, ByVal Serie As String, ByVal Folio As String,
                    ByVal MonedaDR As String, ByVal EquivalenciaDR As String, ByVal NumParcialidad As String,
                    ByVal ImpSaldoAnt As String, ByVal ImpPagado As String, ByVal ImpSaldoInsoluto As String,
                    ByVal ObjetoImpDR As String,
                    Optional ByVal ImpuestosTrasladosDR40 As iImpuestosTrasladosDR40 = Nothing,
                    Optional ByVal ImpuestosRetencionesDR40 As iImpuestosRetencionesDR40 = Nothing) As cPagosDoctoRelacionado20

        Const sProcedure As String = "Add"

        Dim objObjeto As New cPagosDoctoRelacionado20
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cPagosDoctoRelacionado20
        Get
