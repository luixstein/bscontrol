...
Friend Class cCCPRemolques
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cCCPRemolques"

    Public Function Add(ByVal SubTipoRem As String, ByVal Placa As String) As cCCPRemolque

        Const sProcedure As String = "Add"

        Dim objObjeto As New cCCPRemolque
        Try
            With objObjeto
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cCCPRemolque
        Get
