...
Friend Class cCCPPedimentos
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cCCPPedimentos"

    Public Function Add(ByVal Pedimento As String) As cCCPPedimento

        Const sProcedure As String = "Add"

        Dim objObjeto As New cCCPPedimento
        Try
            With objObjeto
                .Pedimento = Pedimento
            End With
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cCCPPedimento
        Get
