...
Friend Class cCCPPartesTransporte
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cCCPPartesTransporte"

    Public Function Add(ByVal ParteTransporte As String) As cCCPParteTransporte

        Const sProcedure As String = "Add"

        Dim objObjeto As New cCCPParteTransporte
        Try
            With objObjeto
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cCCPParteTransporte
        Get
