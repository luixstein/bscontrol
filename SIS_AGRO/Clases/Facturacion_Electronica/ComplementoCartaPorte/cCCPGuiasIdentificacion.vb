...
Friend Class cCCPGuiasIdentificacion
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cCCPGuiasIdentificacion"

    Public Function Add(ByVal NumeroGuiaIdentificacion As String, ByVal DescripGuiaIdentificacion As String, ByVal PesoGuiaIdentificacion As String
                   ) As cCCPGuiaIdentificacion

        Const sProcedure As String = "Add"

        Dim objObjeto As New cCCPGuiaIdentificacion
        Try
            With objObjeto
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cCCPGuiaIdentificacion
        Get
