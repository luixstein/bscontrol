...
Friend Class cCCPUbicaciones
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cCCPcCCPUbicacionesGuiasIdentificacion"

    Public Function Add(ByVal Ubicacion As cCCPUbicacion) As cCCPUbicacion

        Const sProcedure As String = "Add"

        Dim objObjeto As New cCCPUbicacion
        Try
            Partidas.Add(Ubicacion, Partidas.Count + 1)
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cCCPUbicacion
        Get
