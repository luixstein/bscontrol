...
Friend Class cCCPCantidadesTransporta
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cCCPCantidadesTransporta"

    Public Function Add(ByVal Cantidad As String, ByVal IDOrigen As String, ByVal IDDestino As String, ByVal CvesTransporte As String
                   ) As cCCPCantidadTransporta

        Const sProcedure As String = "Add"

        Dim objObjeto As New cCCPCantidadTransporta
        Try
            With objObjeto
                .Cantidad = Cantidad
                .IDOrigen = IDOrigen
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cCCPCantidadTransporta
        Get
