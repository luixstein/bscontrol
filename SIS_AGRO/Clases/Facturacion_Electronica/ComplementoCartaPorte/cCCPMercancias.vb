...
Friend Class cCCPMercancias
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cCCPMercancias"

    Public PesoBrutoTotal As String
    Public UnidadPeso As String
    Public PesoNetoTotal As String
    Public NumTotalMercancias As String
    Public CargoPorTasacion As String

    Public bTieneAutotransporte As Boolean
    Public Autotransporte As New cCCPAutotransporte

    Public Function Add(ByVal Mercancia As cCCPMercancia) As cCCPMercancia
        Const sProcedure As String = "Add"

        Dim objObjeto As New cCCPMercancia
        Try
            Partidas.Add(Mercancia, Partidas.Count + 1)
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cCCPMercancia
        Get
