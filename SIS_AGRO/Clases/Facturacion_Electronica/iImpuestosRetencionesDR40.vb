...
Friend Class iImpuestosRetencionesDR40
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "iImpuestosRetencionesDR40"

    Public Function Add(ByVal BaseDR As String, ByVal ImpuestoDR As String, ByVal TipoFactorDR As String, ByVal TasaOCuotaDR As String, ByVal ImporteDR As String) As iImpuestosRetencionDR40
        Const sProcedure As String = "Add"

        Dim objObjeto As New iImpuestosRetencionDR40
        Try
            With objObjeto
                .BaseDR = BaseDR
                .ImpuestoDR = ImpuestoDR
                .ImpuestoDR = TipoFactorDR
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As iImpuestosRetencionDR40
        Get
