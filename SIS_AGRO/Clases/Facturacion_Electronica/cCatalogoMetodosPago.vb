...
Friend Class cCatalogoMetodosPago
    Implements System.Collections.IEnumerable
    Private Partidas As Collection

    Private Const NombreClase As String = "cCatalogoMetodosPago"

    Public Function Add(ByVal CODIGO_METODO_PAGO_EVENTO As String, ByVal NOMBRE_METODO_PAGO_EVENTO As String, ByVal ESTATUS As String, ByVal ES_DEFAULT As Boolean) As cCatalogoMetodoPago
        Const sProcedure As String = "Add"

        Dim objObjeto As New cCatalogoMetodoPago

        Try
            With objObjeto
                .CODIGO_METODO_PAGO_EVENTO = CODIGO_METODO_PAGO_EVENTO
                .NOMBRE_METODO_PAGO_EVENTO = NOMBRE_METODO_PAGO_EVENTO
                .ESTATUS = ESTATUS
                .ES_DEFAULT = ES_DEFAULT
            End With

            Partidas.Add(objObjeto, CStr(CODIGO_METODO_PAGO_EVENTO))
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cCatalogoMetodoPago
        Get
