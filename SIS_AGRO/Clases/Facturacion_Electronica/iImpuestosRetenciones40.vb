...
Friend Class iImpuestosRetenciones40
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "iImpuestosRetenciones40"

    Public Function Add(ByVal Impuesto As String, ByVal Importe As String) As iImpuestosRetencion40

        Const sProcedure As String = "Add"

        Dim objObjeto As New iImpuestosRetencion40
        ...
        Try
            ...
            Partidas.Add(objObjeto, "N" & CStr(Impuesto) & Importe)
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As iImpuestosRetencion40
        Get
