...
Friend Class cPagosDoctoRelacionados
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cPagosDoctoRelacionados"

    Public Function Add(ByVal IdDocumento As String, ByVal Serie As String, ByVal Folio As String,
                    ByVal MonedaDR As String, ByVal TipoCambioDR As String, ByVal MetodoDePagoDR As String, ByVal NumParcialidad As String,
                    ByVal ImpSaldoAnt As String, ByVal ImpPagado As String, ByVal ImpSaldoInsoluto As String) As cPagosDoctoRelacionado

        Const sProcedure As String = "Add"

        Dim objObjeto As New cPagosDoctoRelacionado
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cPagosDoctoRelacionado
        Get
