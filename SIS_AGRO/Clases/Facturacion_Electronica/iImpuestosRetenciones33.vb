...
Friend Class iImpuestosRetenciones33
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "iImpuestosRetenciones33"

    Public Function Add(Impuesto As String, Importe As String) As iImpuestosRetencion33
        Const sProcedure As String = "Add"

        Dim objObjeto As New iImpuestosRetencion33
        Try
            With objObjeto
                .Impuesto = Impuesto
                .Importe = Importe
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As iImpuestosRetencion33
        Get
