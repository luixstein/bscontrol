...
Friend Class iImpuestosTrasladosDR40
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "iImpuestosTrasladosDR40"

    Public Function Add(ByVal BaseDR As String, ByVal ImpuestoDR As String, ByVal TipoFactorDR As String, ByVal TasaOCuotaDR As String, ByVal ImporteDR As String) As iImpuestosTrasladoDR40

        Const sProcedure As String = "Add"

        Dim objObjeto As New iImpuestosTrasladoDR40
        ...
        Try
            ...
            Partidas.Add(objObjeto, "N" & CStr(ImpuestoDR) & TasaOCuotaDR & TipoFactorDR)
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As iImpuestosTrasladoDR40
        Get
