...
Friend Class cCfdiRelacionados
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cCfdiRelacionados"

    Public TipoRelacion As String

    Public Function Add(ByVal UUID As String) As cCfdiRelacionado

        Const sProcedure As String = "Add"

        Dim objObjeto As New cCfdiRelacionado
        Try
            With objObjeto
                .UUID = UUID
            End With

            Partidas.Add(objObjeto, CStr(UUID))
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cCfdiRelacionado
        Get
