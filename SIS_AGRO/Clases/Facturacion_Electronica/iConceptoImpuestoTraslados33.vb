...
Friend Class iConceptoImpuestoTraslados33
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "iConceptoImpuestoTraslados33"

    Public Function Add(ByVal Base As String, ByVal Impuesto As String, ByVal TipoFactor As String, ByVal TasaOCuota As String, ByVal Importe As String) As iConceptoImpuestoTraslado33
        Const sProcedure As String = "Add"

        Dim objObjeto As New iConceptoImpuestoTraslado33
        Try
            With objObjeto
                .Base = Base
                .Impuesto = Impuesto
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As iConceptoImpuestoTraslado33
        Get
