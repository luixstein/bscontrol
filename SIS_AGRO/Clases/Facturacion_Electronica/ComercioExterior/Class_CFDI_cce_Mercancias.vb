...
Public Class Class_CFDI_cce_Mercancias
    ...
    Public Function Add(ByVal codigoArticulo As String) As Class_CFDI_cce_Mercancia
        Dim objObjeto As New Class_CFDI_cce_Mercancia
        Try
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As Class_CFDI_cce_Mercancia
        Get
