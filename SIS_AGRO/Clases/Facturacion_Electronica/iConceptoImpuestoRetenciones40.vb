...
Friend Class iConceptoImpuestoRetenciones40
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "iConceptoImpuestoRetenciones40"

    Public Function Add(ByVal Base As String, ByVal Impuesto As String, ByVal TipoFactor As String, ByVal TasaOCuota As String, ByVal Importe As String) As iConceptoImpuestoRetencion40
        Const sProcedure As String = "Add"
        Dim objObjeto As New iConceptoImpuestoRetencion40
        ...
        Try
            ...
            Partidas.Add(objObjeto, "N" & Partidas.Count + 1 & CStr(TasaOCuota))
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As iConceptoImpuestoRetencion40
        Get
