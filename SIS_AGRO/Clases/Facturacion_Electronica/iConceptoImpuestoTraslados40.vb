...
Friend Class iConceptoImpuestoTraslados40
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "iConceptoImpuestoTraslados40"

    Public Function Add(ByVal Base As String, ByVal Impuesto As String, ByVal TipoFactor As String, ByVal TasaOCuota As String, ByVal Importe As String) As iConceptoImpuestoTraslado40
        Const sProcedure As String = "Add"

        Dim objObjeto As New iConceptoImpuestoTraslado40
        Try
            With objObjeto
                .Base = Base
                .Impuesto = Impuesto
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As iConceptoImpuestoTraslado40
        Get
