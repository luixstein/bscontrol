...
Friend Class iConceptoImpuestoRetenciones33
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "iConceptoImpuestoRetenciones33"

    Public Function Add(ByVal Base As String, ByVal Impuesto As String, ByVal TipoFactor As String, ByVal TasaOCuota As String, ByVal Importe As String) As iConceptoImpuestoRetencion33
        Const sProcedure As String = "Add"
        Dim objObjeto As New iConceptoImpuestoRetencion33
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As iConceptoImpuestoRetencion33
        Get
