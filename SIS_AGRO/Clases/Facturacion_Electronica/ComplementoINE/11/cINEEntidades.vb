...
Friend Class cINEEntidades
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cINEEntidades"

    Public Function Add(ByVal ClaveEntidad As String, ByVal Ambito As String,
                        Optional ByVal Contabilidades As cINEContabilidades = Nothing) As cINEEntidad

        Const sProcedure As String = "Add"

        Dim objObjeto As New cINEEntidad
        ...
        Try
            ...
            Partidas.Add(objObjeto, "N" & Partidas.Count + 1)
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cINEEntidad
        Get
