...
Friend Class cINEContabilidades
    Implements System.Collections.IEnumerable
    Dim Partidas As Collection

    Private Const NombreClase As String = "cINEContabilidades"

    Public Function Add(ByVal IdContabilidad As String) As cINEContabilidad

        Const sProcedure As String = "Add"

        Dim objObjeto As New cINEContabilidad
...
Fin:
    ...
    Public ReadOnly Property Item(ByVal vntIndexKey As Object) As cINEContabilidad
        Get
