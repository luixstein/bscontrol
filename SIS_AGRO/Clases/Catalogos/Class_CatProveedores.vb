...
#Region "Métodos y procedimientos"
    ...
    Public Overrides Function BusquedaVisual_PorCodigo() As String
        ...
        f.sQl = "SELECT CODIGO_PROVEEDOR,NOMBRE_PROVEEDOR FROM CAT_PROVEEDORES WHERE CODIGO_PLAZA=" & Usuario.Codigo_Plaza & " AND ESTATUS='A' AND "
        f.Inicia("")
        f.ShowDialog()
        Try
            If f.iRows > 0 Then
    ...
    Public Overrides Function BusquedaVisual_PorDescripcion() As String
        ...
        f.sOrder = "NOMBRE_PROVEEDOR"
        f.sTable = "CAT_PROVEEDORES"
        f.sQl = "SELECT CODIGO_PROVEEDOR,NOMBRE_PROVEEDOR FROM CAT_PROVEEDORES WHERE ESTATUS='A' AND "
        f.Inicia("")
        f.ShowDialog()
        Try
            If f.iRows > 0 Then
