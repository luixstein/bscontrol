...
#Region "Métodos y procedimientos"
    ...
    Public Overrides Function BusquedaVisual_PorDescripcion() As String
        ...
        f.sOrder = "NOMBRE_PROVEEDOR"
        f.sTable = "CAT_PROVEEDORES"
        f.sQl = "SELECT P.CODIGO_PROVEEDOR,P.NOMBRE_PROVEEDOR FROM CAT_PROVEEDORES P INNER JOIN SIS_TIPOS_PROVEEDORES T ON(P.CODIGO_TIPO_PROVEEDOR=T.CODIGO_TIPO_PROVEEDOR) " &
