...
#Region "Propiedades Campos de la tabla"
    Public ReadOnly Property ID_LOCALIDAD() As Integer
        Get
...
#Region "Constructor y destructor"
    ...
    Public Sub New(ByVal sCodigoLocalidad As String)
        Me.New()
        Try
            Me._CODIGO_LOCALIDAD = sCodigoLocalidad
...
#Region "Métodos y procedimientos"
    ...
    Public Overrides Function Consultar() As Boolean
        Dim bResultado As Boolean = False
        Dim cmd As New SqlCommand("Select * from CFDI_CAT_LOCALIDADES Where CODIGO_LOCALIDAD='" & sReplace(Me._CODIGO_LOCALIDAD) & "'", Me._Conexion)
        ...
        With cmd
            ...
            Try
                ...
                If dReader.Read Then
                    Me._CODIGO_LOCALIDAD = "" & dReader("CODIGO_COLONIA").ToString
                    Me._NOMBRE_LOCALIDAD = "" & dReader("NOMBRE_COLONIA").ToString
    ...
    Public Overrides Function BusquedaVisual_PorCodigo() As String
        ...
        f.Text = "Búsqueda de localidades por codigo."
