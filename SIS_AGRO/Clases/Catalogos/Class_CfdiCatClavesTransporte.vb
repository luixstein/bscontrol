...
Public Class Class_CfdiCatClavesTransporte
...
#Region "Propiedades Campos de la tabla"
    Public ReadOnly Property CODIGO_TRANSPORTE() As String
        Get
            Return Me._CODIGO_TRANSPORTE
        End Get
    End Property

    Public ReadOnly Property NOMBRE_TRANSPORTE() As String
        Get
...
#Region "Constructor y destructor"
    ...
    Public Sub New()
        Me._Nombre_Catalogo = "CFDI_CAT_CLAVES_TRANSPORTE"
        Me._Nombre_Reporte = "RPT_CATALOGO_CFDI_CLAVES_TRANSPORTE"
        Me._Conexion = New SqlConnection
        Me._Conexion.ConnectionString = Empresa_Sistema.conexion
        Me._QuerySelect = "Select * From CFDI_CAT_CLAVES_TRANSPORTE"
        Me._QueryOrder = " Order by NOMBRE_TRANSPORTE"
...
#Region "Métodos y procedimientos"
    ...
    Public Overrides Function Consultar() As Boolean
        Dim bResultado As Boolean = False
        Dim cmd As New SqlCommand("Select * from CFDI_CAT_CLAVES_TRANSPORTE Where CODIGO_TRANSPORTE='" & sReplace(Me._CODIGO_TRANSPORTE) & "'", Me._Conexion)
    ...
    Public Function ObtenerElementosFiltro(ByVal Filtro As String) As System.Data.DataTable
        Dim dTable As New DataTable
        Dim da As New SqlDataAdapter("SELECT CODIGO_TRANSPORTE,NOMBRE_TRANSPORTE FROM CFDI_CAT_CLAVES_TRANSPORTE WHERE NOMBRE_TRANSPORTE LIKE '" & Filtro.ToString & "%' ORDER BY NOMBRE_TRANSPORTE", Me._Conexion)
        Try
            da.Fill(dTable)
        Catch ex As Exception
    ...
    Public Overrides Function BusquedaVisual_PorCodigo() As String
        ...
        f.Text = "Búsqueda de Clave de transporte por codigo."
        f.sCampo = "CODIGO_TRANSPORTE"
        f.sOrder = "NOMBRE_TRANSPORTE"
        f.sTable = "CFDI_CAT_CLAVES_TRANSPORTE"
        f.sQl = "Select CODIGO_TRANSPORTE,NOMBRE_TRANSPORTE From CFDI_CAT_CLAVES_TRANSPORTE Where 1=1 And"
        f.Inicia("")
        f.ShowDialog()
        Try
            If f.iRows > 0 Then
    ...
    Public Overrides Function BusquedaVisual_PorDescripcion() As String
        Dim f As New BusquedaVisual
        Dim Resultado As String = ""
        f.Text = "Búsqueda de Clave transporte por nombre."
        f.sCampo = "NOMBRE_TRANSPORTE"
        f.sOrder = "NOMBRE_TRANSPORTE"
        f.sTable = "CFDI_CAT_CLAVES_TRANSPORTE"
        f.sQl = "Select CODIGO_TRANSPORTE,NOMBRE_TRANSPORTE From CFDI_CAT_CLAVES_TRANSPORTE Where 1=1 And"
        f.Inicia("")
