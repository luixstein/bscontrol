...
#Region "Métodos y procedimientos"
    ...
    Public Function ObtenerElementosFiltro(ByVal Filtro As String) As System.Data.DataTable
        Dim dTable As New DataTable
        Dim da As New SqlDataAdapter("SELECT CODIGO_TIPO_FIGURA_TRANSPORTE,NOMBRE_TIPO_FIGURA_TRANSPORTE FROM CFDI_CAT_TIPOS_FIGURAS_TRANSPORTE WHERE NOMBRE_TIPO_FIGURA_TRANSPORTE LIKE '" & Filtro.ToString & "%' ORDER BY NOMBRE_TIPO_FIGURA_TRANSPORTE", Me._Conexion)
        Try
            da.Fill(dTable)
        Catch ex As Exception
    ...
    Public Overrides Function BusquedaVisual_PorCodigo() As String
        ...
        f.Text = "Búsqueda de Tipo figura de transporte por codigo."
    ...
    Public Overrides Function BusquedaVisual_PorDescripcion() As String
        Dim f As New BusquedaVisual
        Dim Resultado As String = ""
        f.Text = "Búsqueda de Tipo figura de transporte por nombre."
