...
#Region "Propiedades Campos de la tabla"
    Public ReadOnly Property ID_COLONIA() As Integer
        Get
    ...
    Public ReadOnly Property NOMBRE_COLONA() As String
        Get
...
#Region "Constructor y destructor"
    ...
    Public Sub New(ByVal sCodigoColonia As String)
        Me.New()
        Try
            Me._CODIGO_COLONIA = sCodigoColonia
...
#Region "Métodos y procedimientos"
    ...
    Public Overrides Function Consultar() As Boolean
        Dim bResultado As Boolean = False
        Dim cmd As New SqlCommand("Select * from CFDI_CAT_COLONIAS Where CODIGO_COLONIA='" & sReplace(Me._CODIGO_COLONIA) & "'", Me._Conexion)
    ...
    Public Overrides Function BusquedaVisual_PorCodigo() As String
        ...
        f.Text = "Búsqueda de colonias por codigo."
