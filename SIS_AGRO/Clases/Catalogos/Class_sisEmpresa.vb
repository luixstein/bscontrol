...
#Region "Métodos y procedimientos"
    ...
    Public Function ObtenDocumentosSinTimbrar() As DataTable
        ...
        '"SELECT FOLIO_VENTA FOLIO,CODIGO_DOCUMENTO TIPO,FECHA_SERVIDOR,'NO ESTA TIMBRADO' PROBLEMA,case when (72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()))>0 then 72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()) else 0 end TIEMPO_RESTANTE " &
        '"FROM VENTA_GLOBAL WHERE ES_FACTURA_ELECTRONICA='1' AND TIMBRADO_DESCARTADO='0' AND FECHA_SERVIDOR>'2013-24-12' AND ESTATUS_VENTA='A' AND LEN(FOLIO_FISCAL_SAT)=0 AND LEN(SELLO_SAT)=0" &
        '"UNION ALL " &
        '"SELECT FOLIO_DESCUENTO FOLIO,'NCG_CXC' + CAST(CODIGO_PLAZA AS NVARCHAR) TIPO,FECHA_SERVIDOR,'NO ESTA TIMBRADO' PROBLEMA,case when (72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()))>0 then 72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()) else 0 end TIEMPO_RESTANTE " &
        ...
        "SELECT FOLIO_VENTA FOLIO,CODIGO_DOCUMENTO TIPO,FECHA_SERVIDOR,'NO ESTA TIMBRADO' PROBLEMA,case when (72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()))>0 then 72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()) else 0 end TIEMPO_RESTANTE " &
        "FROM VENTA_GLOBAL " &
        "WHERE ES_FACTURA_ELECTRONICA='1' AND TIMBRADO_DESCARTADO='0' AND FECHA_SERVIDOR>'2013-24-12' AND ESTATUS_VENTA='A' AND FOLIO_FISCAL_SAT IS NULL " &
        "UNION ALL " &
        "SELECT FOLIO_DESCUENTO FOLIO,'NCG_CXC' + CAST(CODIGO_PLAZA AS NVARCHAR) TIPO,FECHA_SERVIDOR,'NO ESTA TIMBRADO' PROBLEMA,case when (72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()))>0 then 72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()) else 0 end TIEMPO_RESTANTE " &
        "FROM CXC_DESCUENTOS_GLOBAL " &
        "WHERE ES_COMPROBANTE_ELECTRONICO='1' AND TIMBRADO_DESCARTADO='0' AND FECHA_SERVIDOR>'2013-24-12' AND ESTATUS_DESCUENTO='A' AND FOLIO_FISCAL_SAT IS NULL " &
        "ORDER BY FECHA_SERVIDOR", Me._Conexion)
    ...
    Public Function ObtenDocumentosCanceladosSinTimbrar() As DataTable
        ...
        'Dim da As New SqlDataAdapter(
        '"SELECT FOLIO_VENTA FOLIO,'FACTURA' TIPO,FECHA_SERVIDOR,'NO ESTA TIMBRADO' PROBLEMA,case when (72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()))>0 then 72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()) else 0 end TIEMPO_RESTANTE " &
        '"FROM VENTA_GLOBAL WHERE ES_FACTURA_ELECTRONICA='1' AND TIMBRADO_DESCARTADO='0' AND FECHA_SERVIDOR>'2013-24-12'   AND ESTATUS_VENTA='C' AND ESTATUS_CANCELACION_CFDI='0' " &
        '"UNION ALL " &
        '"SELECT FOLIO_DESCUENTO FOLIO,'NOTA DE CREDITO' TIPO,FECHA_SERVIDOR,'NO ESTA TIMBRADO' PROBLEMA,case when (72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()))>0 then 72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()) else 0 end TIEMPO_RESTANTE " &
        ...
        Dim da As New SqlDataAdapter(
        "SELECT FOLIO_VENTA FOLIO,'FACTURA' TIPO,FECHA_SERVIDOR,'TIMBRE SIN CANCELAR' PROBLEMA,case when (72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()))>0 then 72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()) else 0 end TIEMPO_RESTANTE " &
        "FROM VENTA_GLOBAL V " &
        ...
        "UNION ALL " &
        "SELECT FOLIO_DESCUENTO FOLIO,'NOTA DE CREDITO' TIPO,FECHA_SERVIDOR,'TIMBRE SIN CANCELAR' PROBLEMA,case when (72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()))>0 then 72-DATEDIFF(HOUR,FECHA_SERVIDOR, GETDATE()) else 0 end TIEMPO_RESTANTE " &
