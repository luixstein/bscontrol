...
#Region "Constructor y destructor"
    ...
    Public Sub New()
        ...
        "C.CODIGO_ALMACEN, " &
        "C.NUMERO_IDENTIFICACION_REGISTRO_FISCAL_EXTRANJERO,C.CODIGO_MUNICIPIO,C.CODIGO_ESTADO,E.CODIGO_ESTADO_SAT,C.CODIGO_PAIS_SAT,M.NOMBRE_MUNICIPIO,E.NOMBRE_ESTADO,P.NOMBRE_PAIS,C.ES_CONTRIBUYENTE_IEPS " &
        "FROM CAT_CLIENTES C " &
