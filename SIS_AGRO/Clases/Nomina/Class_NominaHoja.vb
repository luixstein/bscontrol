...
#Region "Métodos y procedimientos"
    ...
    Public Function ObtenerDetalle() As DataTable
        ...
        Dim sSQL As String
        sSQL = "SELECT T.CODIGO_X_TEMPORADA,T.NOMBRE_TRABAJADOR,T.APELLIDO_PATERNO,T.APELLIDO_MATERNO,E.NOMBRE,P.CODIGO_PERCEPCION,E.REEMBOLSABLE,P.PERCEPCION,P.ID_NOMINA_PERCEPCION,'1' CONFIRMAR,P.JORNALES,P.CAJAS_CORTADAS " &
        "FROM NOMINA_HOJAS_PERCEPCIONES P " &
        "INNER JOIN NOMINA_CAT_TRABAJADORES T ON(P.CODIGO_TRABAJADOR=T.CODIGO_TRABAJADOR) " &
        "INNER JOIN NOMINA_CAT_PERCEPCIONES E ON(P.CODIGO_PERCEPCION=E.CODIGO_PERCEPCION) " &
        "WHERE ID_NOMINA_HOJA= " & Me._ID_NOMINA_HOJA &
