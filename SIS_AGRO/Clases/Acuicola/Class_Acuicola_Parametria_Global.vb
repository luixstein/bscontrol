...
#Region "Métodos y procedimientos"
    ...
    Public Function ObtenerDetalle() As DataTable
        ...
        sSQL = "SELECT R.ID_ACUICOLA_PARAMETRIA_DETALLE,R.ID_PROYECTO_SIEMBRA,P.CANTIDAD_ORGANISMOS,P.HA,R.CODIGO_LOTE,L.NOMBRE_LOTE,R.TARRALLAZOS,R.PESO,R.ORGANISMOS, " &
            "(R.PESO/R.ORGANISMOS) GRAMAJE,0 INCREMENTO,R.MUERTOS,(((R.ORGANISMOS/R.TARRALLAZOS)/6)/(P.CANTIDAD_ORGANISMOS/(P.HA*10000)))*100 PORCENTAJE_SUPERVIVENCIA_CALCULADO, " &
            "R.PORCENTAJE_SUPERVIVENCIA_ESTIMADO " &
            "FROM ACUICOLA_PARAMETRIA_DETALLE R " &
            "INNER JOIN CAT_LOTES L ON(R.CODIGO_LOTE=L.CODIGO_LOTE) " &
            "INNER JOIN PROYECTO_SIEMBRA_ACUICOLA P ON(R.ID_PROYECTO_SIEMBRA=P.ID_PROYECTO_SIEMBRA) " &
            "WHERE R.FOLIO_PARAMETRIA='" & sReplace(Me._FOLIO_PARAMETRIA) & "' " &
            "ORDER BY R.ID_ACUICOLA_PARAMETRIA_DETALLE"
