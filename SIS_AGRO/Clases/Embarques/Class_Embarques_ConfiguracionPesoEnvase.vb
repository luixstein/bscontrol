...
Public Class Class_Embarques_ConfiguracionPesoEnvase
...
#Region "Constructor y destructor"
    ...
    Public Sub New()
        Me._Nombre_Catalogo = "EMB_CONFIGURACION_PESO_ENVASE"
        Me._Nombre_Reporte = "RPT_EMB_CONFIGURACION_PESO_ENVASE"
        Me._Conexion = New SqlConnection
        Me._Conexion.ConnectionString = Empresa_Sistema.conexion
        Me._QuerySelect = "SELECT CODIGO_CULTIVO,CODIGO_TIPO_TAMAÑO,CODIGO_TIPO_ENVASE,PESO FROM EMB_CONFIGURACION_PESO_ENVASE"
...
#Region "Métodos y procedimientos"
    ...
    Public Overrides Function Insertar() As Boolean
        ...
        With cmd
            ...
            .CommandText = "MP_EMB_CONFIGURACION_PESO_ENVASE_GRABA"

            sqlParametro = .Parameters.Add("@CODIGO_CULTIVO", SqlDbType.NVarChar, 4) : sqlParametro.Value = Me._CODIGO_CULTIVO
            sqlParametro = .Parameters.Add("@CODIGO_TIPO_TAMAÑO", SqlDbType.SmallInt) : sqlParametro.Value = Me._CODIGO_TIPO_TAMAÑO.ToString.ToUpper
    ...
    Public Overrides Function Consultar() As Boolean
        Dim cmd As New SqlCommand("Select * from EMB_CONFIGURACION_PESO_ENVASE Where CODIGO_CULTIVO='" & Me._CODIGO_CULTIVO.ToString & "' AND CODIGO_TIPO_ENVASE=" & Me.CODIGO_TIPO_ENVASE.ToString & "", Me._Conexion)
        ...
        With cmd
            ...
            Try
                ...
                If dReader.Read Then
                    ...
                    Me._CODIGO_TIPO_TAMAÑO = CType(dReader("CODIGO_TIPO_TAMAÑO"), Integer)
                    Me._CODIGO_TIPO_ENVASE = CType(dReader("CODIGO_TIPO_ENVASE"), Integer)
                    Me._PESO = CType(dReader("PESO"), Double)
                    Consultar = True
                End If
                dReader.Close()
            Catch ex As Exception
    ...
    Public Overrides Function ObtenerElementos() As System.Data.DataTable
        ...
        Dim dsPeso As New SqlDataAdapter("Select E.CODIGO_CULTIVO,C.NOMBRE_CULTIVO AS CULTIVO,E.CODIGO_TIPO_TAMAÑO,A.NOMBRE_TIPO_TAMAÑO AS TAMAÑO, E.CODIGO_TIPO_ENVASE ,T.NOMBRE_TIPO_ENVASE AS ENVASE,E.PESO FROM EMB_CONFIGURACION_PESO_ENVASE E " & _
        "INNER JOIN CAT_CULTIVOS C ON(E.CODIGO_CULTIVO=C.CODIGO_CULTIVO) " & _
        "INNER JOIN CAT_TIPOS_TAMAÑOS A ON(E.CODIGO_TIPO_TAMAÑO=A.CODIGO_TIPO_TAMAÑO)" & _
    ...
    Public Overrides Function BusquedaVisual_PorCodigo() As String
        ...
        f.sTable = "EMB_CONFIGURACION_PESO_ENVASE"
        f.sQl = "SELECT CODIGO_CULTIVO,CODIGO_TIPO_ENVASE FROM EMB_CONFIGURACION_PESO_ENVASE WHERE 1=1 AND "
        f.Inicia("")
        f.ShowDialog()
        Try
            If f.iRows > 0 Then
    ...
    Public Function ObtenerElementosFiltroCultivo(ByVal Filtro As String) As System.Data.DataTable
        ...
        Dim dA As New SqlDataAdapter("Select  E.CODIGO_CULTIVO,C.NOMBRE_CULTIVO AS CULTIVO,E.CODIGO_TIPO_TAMAÑO,A.NOMBRE_TIPO_TAMAÑO AS TAMAÑO, E.CODIGO_TIPO_ENVASE ,T.NOMBRE_TIPO_ENVASE AS ENVASE,E.PESO FROM EMB_CONFIGURACION_PESO_ENVASE E " & _
        "INNER JOIN CAT_CULTIVOS C ON(E.CODIGO_CULTIVO=C.CODIGO_CULTIVO) " & _
        "INNER JOIN CAT_TIPOS_TAMAÑOS A ON(E.CODIGO_TIPO_TAMAÑO=A.CODIGO_TIPO_TAMAÑO)" & _
        "INNER JOIN CAT_TIPOS_ENVASES T ON(E.CODIGO_TIPO_ENVASE=T.CODIGO_TIPO_ENVASE)" & _
    ...
    Public Function ObtenerElementosFiltroNombreEnvase(ByVal Filtro As String) As System.Data.DataTable
        ...
        Dim dA As New SqlDataAdapter("SELECT  E.CODIGO_CULTIVO,C.NOMBRE_CULTIVO AS CULTIVO,E.CODIGO_TIPO_TAMAÑO,A.NOMBRE_TIPO_TAMAÑO AS TAMAÑO, E.CODIGO_TIPO_ENVASE ,T.NOMBRE_TIPO_ENVASE AS ENVASE,E.PESO FROM EMB_CONFIGURACION_PESO_ENVASE E " & _
        "INNER JOIN CAT_CULTIVOS C ON(E.CODIGO_CULTIVO=C.CODIGO_CULTIVO) " & _
        "LEFT JOIN CAT_TIPOS_TAMAÑOS A ON(E.CODIGO_TIPO_TAMAÑO=A.CODIGO_TIPO_TAMAÑO)" & _
        "INNER JOIN CAT_TIPOS_ENVASES T ON(E.CODIGO_TIPO_ENVASE=T.CODIGO_TIPO_ENVASE)" & _
