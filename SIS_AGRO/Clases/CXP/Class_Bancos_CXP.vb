...
#Region "Métodos y procedimientos"
    ...
    Public Function ObtenerDetalle() As DataTable
        ...
        sSQL = "SELECT B.FOLIO_REFERENCIA_USUARIO,ISNULL(Convert(varchar(10),B.FECHA, 103),'') FECHA,B.FOLIO_REFERENCIA,B.NOMBRE_MONEDA_CO,B.TIPO_DE_CAMBIO_CO,B.SALDO_USD_CO,B.CONCEPTO_COMPRA," &
               "B.TOTAL_COMPRA,B.SALDO_COMPRA,0 SALDO_IMPUESTO,B.IMPUESTO_COMPRA,B.RETENCION_IVA,0 TOTAL_DETALLE_IMPUESTO,B.TOTAL_DETALLE,B.TOTAL_DETALLE_DOLARES,0,B.CODIGO_DOCUMENTO_COMPRA,'' " &
    ...
    Public Function CargaComprasProveedorConSaldo(ByVal CodigoProveedor As String) As DataTable
        ...
        Dim sSQL As String = ("SELECT FOLIO_PROVEEDOR,ISNULL(Convert(varchar(10),G.FECHA, 103),'') FECHA,G.FOLIO_COMPRA,M.ABREVIACION NOMBRE_MONEDA_CO,G.TIPO_DE_CAMBIO,G.SALDO_DOLARES,LEFT(CONCEPTO,40) CONCEPTO, " &
                              "TOTAL,G.SALDO,SALDO_IMPUESTO,G.IMPUESTO,RETENCION_IVA,0 PAGAR_IMPUESTO,ISNULL(A.IMPORTE_AUTORIZADO,0) PAGAR,0 PAGO_USD, " &
