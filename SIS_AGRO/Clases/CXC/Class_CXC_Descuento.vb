...
#Region "Métodos y procedimientos"
    ...
    Public Function ObtenerDetalle() As DataTable
        ...
        "(SELECT ISNULL(MAX(IMPORTE_DESCUENTO) ,0) FROM CXC_DESCUENTOS_DETALLE_CULTIVOS WHERE CODIGO_CULTIVO=P.CODIGO_CULTIVO AND FOLIO_CXC=D.FOLIO_CXC) DESCUENTO,'','','' " & _
        ...
        "INNER JOIN VW_CAT_PRODUCTOS_AGRICOLAS P ON(R.CODIGO_ARTICULO=P.CODIGO_ARTICULO) " & _
