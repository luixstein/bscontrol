...
#Region "Métodos y procedimientos"
    Public Function Consultar() As Boolean
        ...
        sSQL = "SELECT D.*, " &
        "F.FOLIO_FISCAL_SAT FACTURA_FOLIO_FISCAL_SAT,E.SERIE FACTURA_SERIE,F.FOLIO_NUMERICO FACTURA_FOLIO_NUMERICO " &
        ...
        "INNER JOIN CATALOGO_FOLIOS_FACTURAS_ELECTRONICAS E ON(F.IDCATALOGO_FOLIO_FELECTRONICA=E.IDCATALOGO_FOLIO_FELECTRONICA) " &
