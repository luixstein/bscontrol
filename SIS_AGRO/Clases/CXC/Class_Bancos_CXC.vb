...
#Region "Métodos y procedimientos"
    ...
    Public Function ObtenerDetalle() As DataTable
        ...
        sSQL = "SELECT * INTO #VW_SIS_CAT_DOCUMENTOS_EXTENDIDO FROM VW_SIS_CAT_DOCUMENTOS_EXTENDIDO " &
               ...
               "CASE WHEN V.CODIGO_MONEDA_SAT='USD' THEN V.SALDO_DOLARES ELSE 0 /*ROUND(V.SALDO/D.TIPO_DE_CAMBIO_PAGO,2)--EN LA CONSULTA NO SE NECESITA EMULAR UN SALDO EN USD DE VTAS EN MXN, EN LA ELABORACION DE UN PAGO NUEVO EN USD SI*/ END SALDO_DOLARES," &
               "D.PAGO_MXN_BANCOS," &
