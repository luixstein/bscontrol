...
Public Class rptCredenciales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Agrinet.rptCredenciales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCredenciales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCredenciales = New rptCredenciales
        rpt.Site = Me.Site
        Return rpt
    End Function
